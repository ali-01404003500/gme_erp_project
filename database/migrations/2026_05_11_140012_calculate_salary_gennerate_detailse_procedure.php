    ...
    public function up()
    {
        ...
        DB::unprepared("
            ...
            BEGIN
                ...
                SELECT
                    CAST(ADDTIME(in_time, SEC_TO_TIME(delay_buffer * 60)) AS TIME),
                    CAST(ADDTIME(in_time, SEC_TO_TIME(ex_delay_buffer * 60)) AS TIME),
                    CAST(early_out_time AS TIME)
                INTO
                    v_delay_buffer,
                    v_ex_delay_buffer,
                    v_early_out_time
                ...
                WHERE employee_id = emp_id
                AND DAYOFWEEK(check_in_date) != 6
                AND CAST(check_in_time AS TIME) > CAST(v_delay_buffer AS TIME);
                ...
                WHERE employee_id = emp_id
                AND DAYOFWEEK(check_in_date) != 6
                AND CAST(check_in_time AS TIME) > CAST(v_ex_delay_buffer AS TIME);
