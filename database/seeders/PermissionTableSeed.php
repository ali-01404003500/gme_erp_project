...
// Deliveries
 ...
 [
            ...
            [
                'name' => 'USG OPG License Requisitions Verify List',
                'slug' => 'licenses.usg-opg-license-requisitions.verify',
                'description' => 'USG OPG License Requisitions Verify List permission',
                'key' => 'licenses.usg-opg-license-requisitions'
            ],


            [
                'name' => 'CBC License Requisitions Verify List',
                'slug' => 'licenses.cbc-license-requisitions.verify',
                'description' => 'CBC License Requisitions Verify List permission',
                'key' => 'licenses.cbc-license-requisitions'
            ],
