                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">
                                    {{ trans('menu.create-daily-call-menu-title') }}</li>
                            </ol>
                        </nav>
                    </div>
                    ...
                    <div class="col-sm-10">
                        <div class="mt-40 mb-50">
                            <form action="{{ route('crm.daily-calls.store', app()->getLocale()) }}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-25">
                                            ...
                                            <select name="call_type_id" id="call_type_id" class="form-control tom-select">
                                                <option value="">Select Call Type</option>
                                                <option value="1" {{ old('call_type_id') == 1 ? 'selected' : '' }}>Regular Call</option>
                                                <option value="2" {{ old('call_type_id') == 2 ? 'selected' : '' }}>Service Call</option>
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-25">
                                            ...
                                            <input type="text"
                                                   ...
                                                   value="{{ old('call_date', date('Y-m-d')) }}" 
                                                   name="call_date" id="call_date"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <label for="is_account_complain" class="text-capitalize">Account Complain<span class="text-danger">*</span></label>
                                        <select name="is_account_complain" id="is_account_complain" class="form-control tom-select">
                                            <option value="">Select Type</option>
                                            <option value="1" {{ old('is_account_complain') == 1 ? 'selected' : '' }}>Yes</option>
                                            <option value="0" {{ old('is_account_complain') == 0 ? 'selected' : '' }}>No</option>
                                        </select>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mt-25">
                                        <label for="is_service_complain" class="text-capitalize">Service Complain<span class="text-danger">*</span></label>
                                        <select name="is_service_complain" id="is_service_complain" class="form-control tom-select">
                                            <option value="">Select Type</option>
                                            <option value="1" {{ old('is_service_complain') == 1 ? 'selected' : '' }}>Yes</option>
                                            <option value="0" {{ old('is_service_complain') == 0 ? 'selected' : '' }}>No</option>
                                        </select>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mt-25">
                                        <label for="is_product_required" class="text-capitalize">Requirement of Product<span class="text-danger">*</span></label>
                                        <select name="is_product_required" id="is_product_required" class="form-control tom-select">
                                            <option value="">Select Type</option>
                                            <option value="1" {{ old('is_product_required') == 1 ? 'selected' : '' }}>Yes</option>
                                            <option value="0" {{ old('is_product_required') == 0 ? 'selected' : '' }}>No</option>
                                        </select>
                                ...
                                <div class="col-md-12 mt-25">
                                    ...
                                    <textarea name="remarks" id="remarks" class="form-control" cols="30" rows="5">{{ old('remarks') }}</textarea>
                                </div>
