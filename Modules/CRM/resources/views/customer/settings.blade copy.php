                                        ...
                                        <div class="row" id="company-row">
                                            ...
                                            <div class="form-group col-md-4 mb-25">
                                                ...
                                                <select name="customer_rating" id="customer_rating"
                                                    ...
                                                    <option value="1"
                                                        @if (optional($customer)->customer_rating == 1) selected @endif>One Star</option>
                                                    <option value="2"
                                                        @if (optional($customer)->customer_rating == 2) selected @endif>Two Star</option>
                                                    <option value="3"
                                                        @if (optional($customer)->customer_rating == 3) selected @endif>Three Star
                                                    </option>
                                                    <option value="4"
                                                        @if (optional($customer)->customer_rating == 4) selected @endif>Four Star
                                                    </option>
                                                    <option value="5"
                                                        @if (optional($customer)->customer_rating == 5) selected @endif>Five Star
                                                    </option>
                                                </select>
                                    ...
                                    <div class="tab-pane fade" id="tab-v-2" role="tabpanel" aria-labelledby="tab-v-2">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group" id="percentage-section" style="display: none;">
                                                ...
                                                {{-- <br>
                                                <h2>Self Commission Info</h2>
                                                <br>
                                                <div class="row">
                                                    <div class="col-sm-5" style="text-align: right">
                                                        <label class="col-sm-12 control-label">Commission Deduct</label>
                                                    </div>
                                                    <div class="col-sm-4" style="text-align: left; margin-top: -5px">
                                                        <select name="commission_deduct" id="commission_deduct"
                                                            class="form-control" style="flex: 1;">
                                                            @if ($customer->customerSettingSelfCommissions && count($customer->customerSettingSelfCommissions) > 0)
                                                            <option value="1" {{ optional($customer->customerSettingSelfCommissions->first())->commission_deduct == 1 ? 'selected' : '' }}>From Discount Amount</option>
                                                            <option value="2" {{ optional($customer->customerSettingSelfCommissions->first())->commission_deduct == 2 ? 'selected' : '' }}>From Original Amount</option>
                                                            @else
                                                            <option value="1">From Discount Amount</option>
                                                            <option value="2">From Original Amount</option>
                                                            @endif
                                                        </select>
                                                    </div>
                                                </div>
                                                <br>
                                                <table class="table table-bordered self-commission-table">
                                                    <thead>
                                                        <th>Percentage Type</th>
                                                        <th>Percentage %</th>
                                                        <th>
                                                            <div class="btn-group btn-corner">
                                                                <button class="btn btn-success btn-xs add-row"
                                                                    onclick="addSelfCommissionRow()" type="button">
                                                                    <i class="fa fa-plus"></i>
                                                                </button>
                                                            </div>
                                                        </th>
                                                    ...
                                                    <tbody>
                                                        @if ($customer->customerSettingSelfCommissions && count($customer->customerSettingSelfCommissions) > 0)
                                                        @foreach ($customer->customerSettingSelfCommissions as $key => $value)
                                                        <tr>
                                                            <td>
                                                                <select name="self_commission_percentage_type[]" class="form-control"
                                                                    onchange="getSelfCommission(this)">
                                                                    <option value="">Select Type</option>
                                                                    @foreach ($percentageTypes as $percentageType)
                                                                        <option value="{{ $percentageType->id }}" {{ $value->percentage_type == $percentageType->id ? 'selected' : '' }}>
                                                                            {{ $percentageType->name }}</option>
                                                                    @endforeach
                                                                </select>
                                                            </td>
                                                            <td>
                                                                <input type="number" class="form-control input-sm"
                                                                      name="self_commission_percentage[]" value="{{ $value->self_commission_percentage }}"
                                                                    placeholder="percentage"
                                                                    oninput="this.value = Math.min(this.value, 100);">
                                                            </td>
                                                            ...
                                                            <td>
                                                                <div class="btn-group btn-corner">
                                                                    <button class="btn btn-danger btn-xs"
                                                                        onclick="deleteSelfCommissionRow(this)"
                                                                        type="button">
                                                                        <i class="fa fa-trash"></i>
                                                                    </button>
                                                                </div>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <select name="self_commission_percentage_type[]"
                                                                    class="form-control"
                                                                    onchange="getSelfCommission(this)">
                                                                    <option value="">Select Type</option>
                                                                    @foreach ($percentageTypes as $percentageType)
                                                            ...
                                                            <td>
                                                                <input type="number" class="form-control input-sm"
                                                                    name="self_commission_percentage[]" value=""
                                                                    placeholder="percentage" oninput="this.value = Math.min(this.value, 100);">
                                                            </td>
                                                        ...
                                                        <div class="col-md-5">
                                                            <div class="form-group mb-25">
                                                                ...
                                                                <select class="form-control tom-select"
                                                                    name="product_tag_id" id="product_tag_id">
                                                        ...
                                                        <div class="col-md-5">
                                                            <div class="form-group mb-25">
                                                                ...
                                                                <input type="number" class="form-control"
                                                                    id="sales_amount" name="sales_amount" value=""
                                                                    placeholder="Amount">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-2 ">
...
@section('page_scripts')
                    ...
                    <table class="table table-bordered percentage-table">
                        <thead>
                            <tr>
                                <th>Percentage Type</th>
                                <th>Percentage %</th>
                                <th><button class="btn btn-success btn-xs" onclick="addPercentageRow()" type="button"><i class="fa fa-plus"></i></button></th>
                            </tr>
                        </thead>
    ...
    <script>
        function addSelfCommissionRow() {

            var table = $(".self-commission-table tbody tr:last")
            table.clone().find('input').val('').end().insertAfter(table);
        }

        function deleteSelfCommissionRow(object) {

            var table = $(".self-commission-table tbody tr")
            ...
            if (table.length > 1) {
                ...
                $(object).closest('tr').find('select option:selected').removeAttr('selected');
            }
        }
    </script>
    <script>
    ...
    <script>
        function addRow() {
            var original = $(".shipping-item-list").first();
        ...
        function deleteRow(object) {
            var rows = $(".shipping-item-list");
            if (rows.length > 1) {
                $(object).closest('.shipping-item-list').remove();
            }
        }
