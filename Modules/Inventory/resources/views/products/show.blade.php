...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row" id="title">
            <div class="col-lg-12">
                <div class="d-flex justify-content-between align-items-center user-member__title mb-30 mt-30">
                    <h3 class="text-capitalize">{{ trans('product Details') }}</h3>
                    <a href="{{ route('inv.products.show', $product->id) }}?export=pdf" target="_blank"
                        class="btn btn-primary ml-auto">PDF</a>
                </div>
            </div>
        </div>
        <div class="card mb-50" style="padding-left: 40vh; padding-right: 40vh; padding-top: 5vh; padding-bottom: 5vh">
