                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">
                                        {{ trans('menu.product-list-menu-title') }}</li>
                                </ol>
                            </nav>
                        </div>
                    ...
                    <div class="support-form d-flex justify-content-between align-items-center flex-wrap">
                        <form action="{{ route('inv.product-types.store') }}" method="post">
                            <div class="row">
                                ...
                                <div class="col">
                                    <label for="productName" class="text-muted" style="font-size: 0.8rem;">Product
                                        Name:</label>
                                    <input id="productName" name="productName" type="text" class="form-control">
                                </div>
                                <div class="col">
                                    <label for="productModel" class="text-muted" style="font-size: 0.8rem;">Product
                                        Model:</label>
                                ...
                                <div class="col">
                                    <label for="salesQuantity" class="text-muted" style="font-size: 0.8rem;">Sales
                                        Quantity:</label>
                                    <input id="salesQuantity" name="salesQuantity" type="number" class="form-control">
                                </div>
                                <div class="col">
                                    <label for="purchaseQuantity" class="text-muted" style="font-size: 0.8rem;">Purchase
                                        Quantity:</label>
                                    <input id="purchaseQuantity" name="purchaseQuantity" type="number"
                                        class="form-control">
                                </div>
                                <div class="col">
                                    <label for="ruleStatus" class="text-muted" style="font-size: 0.8rem;">Rule
                                        Status:</label>
                        ...
                        <div class="col-lg-10">
                            <div class="dropdown-list">
                                ...
                                <div class="dropdown dropdown-click">
                                    <div class="btn-group dropleft">
                                        <div class="col">
                                            <label for="productModel" class="text-muted" style="font-size: 0.8rem; width:180px!important">Product Model:</label>
                                            <select class="form-control tom-select" id="product_model_id" name="product_model_id">
                                ...
                                <div class="dropdown dropdown-click">
                                    <div class="btn-group dropleft">
                                        <div class="col">
                                            <label for="ruleStatus" class="text-muted" style="font-size: 0.8rem; width:180px!important">Rule Status:</label>
                                            <select class="form-control tom-select" id="ruleStatus" name="ruleStatus">
                                                <option value="active">Active</option>
                                                <option value="inactive">Inactive</option>
                                            </select>
                                        </div>                                        
            ...
            <div class="row">
                <div class="col-md-12" style="padding-bottom: 20px">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('inv.products.import') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        <button type="submit" class="btn btn-primary" style="margin-top: 30px;">Import</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                ...
                <div class="col-md-12" style="padding-bottom: 20px">
                    <div class="row" style="width: 100%">
                        <div class="col-md-6">
                            <h4 class="text-capitalize breadcrumb-title">{{ trans('menu.product-list-menu-title') }}</h4>
                        </div>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            <table id="zero-config" class="table dt-table-hover" data-page='@include('utils.table_paginate', ['data' => $products])'
                                style="width:100%">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($products as $key => $product)
                                        ...
                                        <td>{{ ($products->currentPage() - 1) * $products->perPage() + $loop->iteration  }}</td>
                                            <td class="text-center">{{ $product->hs_code }}</td>
                                            <td class="text-center">{{ optional($product->productCatalog)->name }}</td>
                                            <td class="text-center">{{ $product->description }}</td>
                                            {{-- <td class="text-center">{{ $product->brand->name }}</td> --}}
                                            <td class="text-center">{{ optional($product->productType)->name }}</td>
                                            <td class="text-center">{{ optional($product->tag)->name }}</td>
                                                ...
                                                <div class="btn-group btn-group-sm" role="group"
                                                    ...
                                                    @if (hasPermission('products.update'))
                                                        <a class="btn btn-outline-warning"
                                                            href="{{ route('inv.products.edit', $product->id) }}"><i
                                                                class="far fa-edit"></i></a>
                                                    @endif

                                                    @if (hasPermission('products.destroy'))
                                                        <button type="button"
                                                            data-action="{{ route('inv.products.destroy', $product->id) }}"
                                                    ...
                                                    @if (hasPermission('products.view'))
                                                        <a class="btn btn-outline-primary"
                                                            href="{{ route('inv.products.show', $product->id) }}"><i
                                                                class="fas
                                                            fa-eye"></i></a>
                                                    @endif
                                                </div>
