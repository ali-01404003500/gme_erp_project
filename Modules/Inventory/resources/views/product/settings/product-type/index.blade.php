        ...
        <div class="social-dash-wrap">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            <table id="zero-config" class="table dt-table-hover" data-page='@include('utils.table_paginate', ['data' => $productTypes])' style="width:100%">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($productTypes as $key => $item)
                                        <tr>
                                        <td class="text-center">{{ ($productTypes->currentPage() - 1) * $productTypes->perPage() + $loop->iteration  }}</td>
