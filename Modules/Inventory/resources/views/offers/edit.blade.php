...
@section('description', 'Edit Offer')
@section('page-head')
    <style>
        td.sale-product {
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">
                                        {{ trans('menu.edit-offer-menu-title') }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-12" style="padding-bottom: 20px">
                    <div class="row" style="width: 100%">
                        <div class="col-md-6">
                            <h4 class="text-capitalize breadcrumb-title">{{ trans('menu.edit-offer-menu-title') }}</h4>
                            <x-error-alart />
                        </div>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            <form action="{{ route('inv.offers.update', $offer->id) }}" method="post">
                                @csrf
                                @method('put')
                                ...
                                <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control flatdate" name="applied_date"
                                                placeholder="DD/MM/YYYY" value="{{ old('applied_date', $offer->applied_date) }}" id="applied_date">
                                        </div>
                                        <div class="col-md-4">
                                            <label for="stop_date">Stop Date:</label>
                                            <input type="text" class="form-control flatdate" name="stop_date"
                                                placeholder="DD/MM/YYYY" id="stop_date" value="{{ old('stop_date', $offer->stop_date) }}">
                                        </div>
                                        <div class="col-md-4 mt-3">
                                            <label for="times">Times:</label>
                                            <input type="text" class="form-control" name="times" id="times"
                                                value="{{ old('times', $offer->times) }}">
                                        </div>
                                        <div class="col-md-4 mt-3">
                                            <label for="offer_type">Select Offer:</label>
                                            <select name="offer_type" id="offer_type" class="form-control">
                                                <option value="">Select Offer Type</option>
                                                <option value="discount" @if (old('offer_type', $offer->offer_type) == 'discount') selected @endif>
                                                    Discounts</option>
                                                <option value="gift" @if (old('offer_type', $offer->offer_type) == 'gift') selected @endif>
                                                    Gifts</option>
                                                <option value="clearance" @if (old('offer_type', $offer->offer_type) == 'clearance') selected @endif>
                                                    Clearance</option>
                                            </select>
                                        </div>
                                        <div class="col-md-4 mt-3">
                                            ...
                                            <select name="invoice_type" id="invoice_type" class="form-control">
                                                <option value="paid" @if (old('invoice_type', $offer->invoice_type) == 'paid') selected @endif>
                                                    PAID</option>
                                                <option value="paid_due" @if (old('invoice_type', $offer->invoice_type) == 'paid_due') selected @endif>
                                                    PAID & DUE</option>
                                                <option value="n/a" @if (old('invoice_type', $offer->invoice_type) == 'n/a') selected @endif>N/A
                                                </option>
                                            </select>
                                        </div>
                                        <div class="col-md-4 mt-3">
                                            <label for="rule_status">Rule Status:</label>
                                            <select name="rule_status" id="rule_status" class="form-control">
                                                <option value="running" @if (old('rule_status', $offer->rule_status) == 'running') selected @endif>
                                                    Running</option>
                                                <option value="stop" @if (old('rule_status', $offer->rule_status) == 'stop') selected @endif>
                                                    Stop</option>
                                            </select>
                                        </div>
                                        <div class="col-md-4 mt-3">
                                            <label for="rule_type">Rules Applied Type:</label>
                                            <select name="rule_type" id="rule_type" class="form-control">
                                                <option value="once_in_time"
                                                    @if (old('rule_type', $offer->rule_type) == 'once_in_time') selected @endif>Once in time</option>
                                                <option value="daily" @if (old('rule_type', $offer->rule_type) == 'daily') selected @endif>
                                                    Daily</option>
                                                <option value="weekly" @if (old('rule_type', $offer->rule_type) == 'weekly') selected @endif>
                                                    Weekly</option>
                                                <option value="monthly" @if (old('rule_type', $offer->rule_type) == 'monthly') selected @endif>
                                                    Monthly</option>
                                                <option value="yearly" @if (old('rule_type', $offer->rule_type) == 'yearly') selected @endif>
                                                    Yearly</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 offers offers-gift">
                                        <div id="gift-offers-container">
                                            @if($offer->offer_type == 'gift')
                                                @foreach ($offer->offerDetails as $index => $detail)
                                                    <div class="offer-section-wrapper" data-index="{{ $index }}">
                                                        @if($index > 0)
                                                            ...
                                                            <table class="table table-bordered">
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th style="width:50%; text-align:center;">Offer Product</th>
                                                                    </tr>
                                                                    <tr>
                                                                        <th>
                                                                            <div class="fields">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td style="background-color: #baffdd;text-align:center;font-weight: 800;">Offer Products</td>
                                                                    </tr>
                                                                    <tr>
                                                                            ...
                                                                            <table class="table">
                                                                                ...
                                                                                <tbody>
                                                                                    @foreach ($detail->giftSalesProducts as $product)
                                                                                        <tr>
                                                                                            <td>
                                                                                                {{ $product->product->brand->name ?? '' }} - {{ $product->product->name }}{{ $product->product->model ? ' (' . $product->product->model . ')' : '' }}
                                                                                                <input type="hidden" name="buying_product_id[{{$index}}][]" value="{{ $product->product_id }}">
                                                                                            </td>
                                                                                            <td>
                                                                                                {{ $product->quantity }}
                                                                                                <input type="hidden" name="buying_quantity[{{$index}}][]" value="{{ $product->quantity }}">
                                                                                            </td>
                                                                                            <td>
                                                                                ...
                                                                                <tbody>
                                                                                    @foreach ($detail->giftOfferProducts as $product)
                                                                                        <tr>
                                                                                            <td>
                                                                                                {{ $product->product->brand->name ?? '' }} - {{ $product->product->name }}{{ $product->product->model ? ' (' . $product->product->model . ')' : '' }}
                                                                                                <input type="hidden" name="offer_product_id[{{$index}}][]" value="{{ $product->product_id }}">
                                                                                            </td>
                                                                                            <td>
                                                                                                {{ $product->quantity }}
                                                                                                <input type="hidden" name="offer_quantity[{{$index}}][]" value="{{ $product->quantity }}">
                                                                                            </td>
                                                                                            <td>
                                                                                                <button class="btn btn-danger btn-xs remove-product" type="button">
                                                                                                    <i class="fa fa-times"></i>
                                        ...
                                        <div class="d-flex justify-content-end mt-3">
                                            <button type="button" class="btn btn-primary btn-sm" onclick="addGiftOffer()">
                                                <i class="fa fa-plus"></i> Add Gift Offer
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 offers offers-discount">
                                        <div id="discount-offers-container">
                                                                                ...
                                                                                <tbody>
                                                                                    @foreach ($detail->discountSalesProducts as $product)
                                                                                        <tr>
                                                                                            <td>
                                                                                                {{ $product->product->brand->name ?? '' }} - {{ $product->product->name }}{{ $product->product->model ? ' (' . $product->product->model . ')' : '' }}
                                                                                                <input type="hidden" name="buying_product_id[{{$index}}][]" value="{{ $product->sales_product }}">
                                                                                            </td>
                                                                                            <td>
                                                                                                {{ $product->sales_quentity }}
                                                                                                <input type="hidden" name="buying_quantity[{{$index}}][]" value="{{ $product->sales_quentity }}">
                                                                                            </td>
                                                                                            <td>
                                                                                                <button class="btn btn-danger btn-xs remove-product" type="button">
                                                                                                    <i class="fa fa-times"></i>
                                                                                    ...
                                                                                    @foreach ($detail->offerDiscounts as $discount)
                                                                                        <tr>
                                                                                            <td>
                                                                                                ...
                                                                                                <input type="hidden" name="discount_type[{{$index}}][]" value="{{ $discount->discount_type }}">
                                                                                            </td>
                                                                                            <td>
                                                                                                {{ $discount->discount_quentity }}
                                                                                                <input type="hidden" name="discount_amount[{{$index}}][]" value="{{ $discount->discount_quentity }}">
                                                                                            </td>
                                                                                            <td>
                                                                                                <button class="btn btn-danger btn-xs remove-product" type="button">
                                                                                                    <i class="fa fa-times"></i>
                                        ...
                                        <div class="d-flex justify-content-end mt-3">
                                            <button type="button" class="btn btn-primary btn-sm" onclick="addDiscountOffer()">
                                                <i class="fa fa-plus"></i> Add Discount Offer
                                            </button>
                                        </div>
                                    </div>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-bordered">
                                                                ...
                                                                <th colspan="6">
                                                                    <div class="row add-range-row">
                                                                        <div class="col-md-2">
                                                                            ...
                                                                            <input type="number" step="0.01" class="numberOnly form-control buying_amount_from" placeholder="From">
                                                                        </div>
                                                                        <div class="col-md-2">
                                                                            <label>* End Range</label>
                                                                            <input type="number" step="0.01" class="numberOnly form-control buying_amount_to" placeholder="To">
                                                                        </div>
                                                                        <div class="col-md-3">
                                                                        ...
                                                                        <div class="col-md-3">
                                                                            ...
                                                                            <input type="number" step="0.01" class="numberOnly form-control discount_amount" placeholder="Amount">
                                                                        </div>
                                                        ...
                                                        <tbody class="range-tbody">
                                                            @if($offer->offer_type == 'clearance' && $offer->offerDetails->count() > 0)
                                                                @php
                                                                    $detail = $offer->offerDetails->first();
                                                                @endphp
                                                                @if($detail->clearanceOfferRanges ?? [])
                                                                    @foreach ($detail->clearanceOfferRanges as $rangeIndex => $range)
                                                                        <tr>
                                                                            <td>{{ $rangeIndex + 1 }}</td>
                                                                            <td>
                                                                                {{ number_format((float)$range->buying_amount_from) }}
                                                                                <input type="hidden" name="buying_amount_from[0][]" value="{{ $range->buying_amount_from }}">
                                                                            </td>
                                                                            <td>
                                                                                {{ number_format((float)$range->buying_amount_to) }}
                                                                                <input type="hidden" name="buying_amount_to[0][]" value="{{ $range->buying_amount_to }}">
                                                                            </td>
                                                                            <td>
                                                                                {{ ucfirst($range->gift_type) }}
                                                                                <input type="hidden" name="gift_type[0][]" value="{{ $range->gift_type }}">
                                                                            </td>
                                                                            <td>
                                                                                {{ number_format((float)$range->gift_amount) }}
                                                                                <input type="hidden" name="gift_amount[0][]" value="{{ $range->gift_amount }}">
                                                                            </td>
                                                                            <td>
                                                                                <button class="btn btn-danger btn-xs remove-product" type="button">
                                                                                    <i class="fa fa-times"></i>
                                                        ...
                                                        <tbody class="products-tbody">
                                                            @if($offer->offer_type == 'clearance' && $offer->offerDetails->count() > 0)
                                                                @php
                                                                    $detail = $offer->offerDetails->first();
                                                                @endphp
                                                                @if($detail->giftOfferProducts ?? [])
                                                                    @foreach ($detail->giftOfferProducts as $productIndex => $product)
                                                                        <tr>
                                                                            <td>{{ $productIndex + 1 }}</td>
                                                                            <td>
                                                                                {{ $product->product->brand->name ?? '' }} - {{ $product->product->name }}{{ $product->product->model ? ' (' . $product->product->model . ')' : '' }}
                                                                                <input type="hidden" name="clearance_product_id[0][]" value="{{ $product->product_id }}">
                                                                            </td>
                                                                            <td>
                                                                                <button class="btn btn-danger btn-xs remove-product" type="button">
                                                                                    <i class="fa fa-times"></i>
...
<script>
    let cache = {};
    let giftOfferIndex = {{ $offer->offer_type == 'gift' ? $offer->offerDetails->count() : 0 }};
    let discountOfferIndex = {{ $offer->offer_type == 'discount' ? $offer->offerDetails->count() : 0 }};
    let productCache = {};
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.remove-product', function() {
            ...
            // Reindex serial numbers if needed
    ...
    function addProduct(button, productType) {
        ...
        if (!brandId || !productId || !quantity || quantity < 1) {
            toastr.warning('Please select brand, product and valid quantity');
            return;
        }
    ...
    function addDiscountToOffer(elem) {
        ...
        if (!discountType || !discountAmount || discountAmount < 0) {
            toastr.warning('Please enter valid discount type and amount.');
            return;
        }
    ...
    function addRangeWithDiscount(button) {
        ...
        const rowTemplate = `
            <tr>
                ...
                <td>
                    ${parseFloat(discountAmount).toFixed()}
