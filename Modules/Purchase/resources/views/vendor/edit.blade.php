...
@section('description', 'Vendor Update')
@extends('layout.app')
@section('content')
        ...
        <div class="social-dash-wrap">
                    ...
                    <div class="breadcrumb-main">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">
                                        {{ trans('menu.update-vendor-menu-title') }}</li>
                                </ol>
                            </nav>
                        </div>
                        <div class="breadcrumb-main__wrapper">
                            <div class="action-btn mt-sm-0 mt-15 row">
                                ...
                                <a href="{{ route('purchase.vendors.create') }}" class="btn px-20 btn-primary btn-sm" style="margin-left: 5px;">
            ...
            <div class="row">
                <div class="col-md-12 m-2">
                    <h4 class="text-capitalize breadcrumb-title">{{ trans('menu.update-vendor-menu-title') }}</h4>
                    <x-error-alart />
                </div>
                                            ...
                                            <div class="row" id="company-row">
                                                ...
                                                <div class="form-group col-md-4 mb-25">
                                                    ...
                                                    <select
                                                        ...
                                                        <option value="3" @if($vendor->company_type_id == 3) selected @endif>Public Limited</option>
                                                        <option value="4" @if($vendor->company_type_id == 4) selected @endif>Government Organisation</option>
                                                        <option value="5" @if($vendor->company_type_id == 5) selected @endif>None</option>
                                                    </select>

                                                    @if ($errors->has('company_type_id'))
                                                        <p class="text-danger">
                                                            {{ $errors->first('company_type_id') }}</p>
                                                    @endif
                                                ...
                                                <div class="form-group col-md-4 mb-25">
                                                    ...
                                                    <select
                                                        ...
                                                        <option value="3" @if($vendor->account_head_id == 3) selected @endif> Purchase</option>
                                                    </select>
                                        ...
                                        <div class="tab-pane fade" id="tab-v-3" role="tabpanel"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="account-profile d-flex align-items-center mb-4 ">
                                                        <div class="form-group">
                                                            <x-file-uploader :value="$vendor->front_image" name="front_image"/>

                                                            {{-- <input id="front-image" type="file" accept="image/*"
                                                                name="front_image" class="file-control"
                                                                data-value="{{ $vendor->front_image }}"> --}}
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="account-profile d-flex align-items-center mb-4 ">
                                                        <div class="form-group">
                                                            <x-file-uploader :value="$vendor->back_image" name="back_image"/>
                                                            {{-- <input id="back-image" type="file" accept="image/*"
                                                                name="back_image" class="file-control"
                                                                data-value="{{ $vendor->back_image }}"> --}}
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="account-profile d-flex align-items-center mb-4 ">
                                                        <div class="form-group">
                                                            <x-file-uploader :value="$vendor->visiting_card_front" name="visiting_card_front"/>
                                                            {{-- <input id="visiting-card-front" type="file"
                                                                accept="image/*" name="visiting_card_front"
                                                                class="file-control"
                                                                data-value="{{ $vendor->visiting_card_front }}"> --}}
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="account-profile d-flex align-items-center mb-4 ">
                                                        <div class="form-group">
                                                            <x-file-uploader :value="$vendor->trade_license" name="trade_license"/>
                                                            {{-- <input id="trade-license" type="file" accept="image/*"
                                                                name="trade_license" class="file-control"
                                                                data-value="{{ $vendor->trade_license }}"> --}}
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="account-profile d-flex align-items-center mb-4 ">
                                                        <div class="form-group">
                                                            <x-file-uploader :value="$vendor->signature" name="signature"/>
                                                            {{-- <input id="signature" type="file" accept="image/*"
                                                                name="signature" class="file-control"
                                                                data-value="{{ $vendor->signature }}"> --}}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
