            ...
            <div class="row justify-content-center">
                <div class="col-sm-10">
                    <div class="mt-40 mb-50">
                        <form action="{{ route('services.document-entries.update', $serviceDocumentEntry->id ) }}" method="POST"
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control flatdate " name="document_date" id="document_date"
                                        placeholder="Date" value="{{ old('document_date', $serviceDocumentEntry->document_date) }}" required>
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="product_id" id="product_id" class="form-control  "
                                        ...
                                        <option value="{{ $serviceDocumentEntry->product_id }}" selected>
                                            {{ $serviceDocumentEntry->product->name }}
                                        </option>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea name="remarks" id="remarks" class="form-control" placeholder="Remarks">{{ old('remarks', $serviceDocumentEntry->remarks) }}</textarea>
                                </div>

                                <div class="form-group col-md-6">
                                    <label for="file">File<span class="text-danger">*</span></label>
                                    <x-file-uploader name="documents" :value="$serviceDocumentEntry->documents" />
                                    {{-- <input id="attachment" type="file" class="file-control form-control"  name="attachment" data-old="{{ $serviceDocumentEntry->attachment }}"
