        ...
        <div class="social-dash-wrap">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">
                                        {{ trans('menu.create-service-menu-title') }}</li>
                                </ol>
                            </nav>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12 m-2">
                    <h4 class="text-capitalize breadcrumb-title">{{ trans('menu.create-service-menu-title') }}</h4>
                    <x-error-alart />
                </div>
                ...
                <div class="row justify-content-center" id="justify-content-center">
                    <div class="col-sm-11">
                        <div class="mt-40 mb-50">
                            ...
                            <form action="{{ route('services.service.store', app()->getLocale()) }}" method="POST"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="customer_id" id="customer_id" class="form-control tom-select" onchange="onChangeCustomer(this)">
                                                <option value="">{{ __('Select Customer') }}</option>
                                                @foreach ($customers as $customer)
                                                    <option value="{{ $customer->id }}" {{ old('customer_id') == $customer->id ? 'selected' : '' }} data-phone = "{{ $customer->phone }}" data-address="{{ $customer->address }}">{{ $customer->company_name }} - {{ $customer->address}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <input type="hidden" name="address" id="address">
                                        <input type="hidden" name="product_type" id="product_type" value="Imaging/Radiology Product">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="invoice_id" id="sales_order_id" class="form-control tom-select" onchange="handleInvoiceChange(this)">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="product_catalog_id" id="product_catalog_id" class="form-control tom-select">
                                                ...
                                                @foreach ($productCatalogs as $productCatalog)
                                                    <option value="{{ $productCatalog->id }}" data-warranty_period="{{ $productCatalog->warranty_period }}" data-warranty_period_input="{{ $productCatalog->warranty_period_input }}">{{ $productCatalog->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <h2 class="mb-3 mt-3">Assign Section</h2>
                                <div class="form-group">
                                    <div class="form-check">
                                        <input class="form-check-input " type="checkbox" name="is_assigned" id="is_assigned" onchange="this.value = this.checked ? 1 : 0; showHideEngineer(this)">
                                ...
                                <div class="row">
                                    <div class="col-md-5" id="engineerDiv">
                                        <div class="form-group">
                                            <label for="assigned_engineer_id">{{ __('Assigned Engineer') }}:</label>
                                            <select name="assigned_engineer_id" id="assigned_engineer_id" class="form-control select2" disabled>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="service_date" id="service_date" class="form-control" value="{{ date('Y-m-d') }}" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label for="service_priority">{{ __('Service Priority') }}:</label>
                                            <select name="service_priority" id="service_priority" class="form-control" disabled>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="remarks" id="remarks" class="form-control" placeholder="{{ __('Remarks') }}" disabled></textarea>
                                </div>

                                
                                <input type="hidden" name="status" id="status" value="entry" />
    ...
    const serialSelect = new TomSelect('#serial_number', {
        ...
        create: function (input, callback) {
            ...
            $.ajax({
                ...
                error: function (xhr) {
                    alert(xhr.responseJSON?.message || 'Failed to create new Serial Number');
                    callback();
                }
            });
        },
