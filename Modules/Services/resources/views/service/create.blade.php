                        ...
                        <div class="col-sm-11">
                            <div class="mt-40 mb-50">
                                ...
                                <form action="{{ route('services.service.store', app()->getLocale()) }}" method="POST"
                                    ...
                                    <div class="form-group">
                                        <div class="form-check">
                                            <input class="form-check-input " type="checkbox" name="is_assigned"
                                                id="is_assigned"
                                                onchange="this.value = this.checked ? 1 : 0; showHideEngineer(this)">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select name="service_type_name" class="form-control">
                                                    <option value="ON SPOT">ON SPOT</option>
                                                    <option value="IN HOUSE">IN HOUSE</option>
                                                    <option value="ON CALL">ON CALL</option>
                                                </select>
                                    ...
                                    <input type="hidden" name="action" id="action" value="Pending" />
