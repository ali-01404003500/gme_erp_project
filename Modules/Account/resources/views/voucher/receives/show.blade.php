        ...
        <div class="col-sm-12">
            ...
            <div class="widget-box widget-color-white ui-sortable-handle clearfix" id="widget-box-7" style="width: 90%; margin-left: 5%; margin-top: 30px">
                ...
                <div class="widget-header widget-header-small">
                    ...
                    <div class="widget-toolbar">
                        <a href="{{ route('account.voucher-receives.index') }}" ><i class="fa fa-list-alt"></i> List</a>
                    </div>

                    <div class="widget-toolbar">
                        <a href="{{ route('account.voucher-receives.create') }}" ><i class="fa fa-plus"></i> Create</a>
                    </div>
                </div>
                ...
                @if(request('type') == 'approve' && !$voucher->is_approved)
                    <div class="row" style="width: 100%; margin: 0 !important; padding-bottom: 15px">
                        <div class="col-md-12 text-right">
                            <form action="{{ route('account.voucher-receives.approve', $voucher->id) }}" method="post">
                                @csrf
