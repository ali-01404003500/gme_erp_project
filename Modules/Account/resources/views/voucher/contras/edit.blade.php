...
@section('description', 'Edit Contra Voucher')
@extends('layout.app')
        ...
        <div class="social-dash-wrap">
            ...
            <div class="row">
                <div class="col-md-12 m-2">
                    <h4 class="text-capitalize breadcrumb-title">{{ trans('Edit Contra Voucher') }}</h4>
                    <x-error-alart />
                </div>
                <div class="col-md-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            <form id="form" action="{{ route('account.voucher-contras.update', $voucher->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                        ...
                                        <div class="row mt-2">
                                            ...
                                            <div class="button-group d-flex pt-25 justify-content-md-end justify-content-start">
                                                <div class="btn-group">
                                                    ...
                                                    @if(hasPermission("account.voucher-contras.approve") && request('type') == 'approve')
