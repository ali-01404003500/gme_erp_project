...
@section('description', 'Contra Vouchers')
@section('page-head')
    <style type="text/css">
        .bg-qty {
            background: #5759604a;
                        ...
                        <div class="breadcrumb-main__wrapper">
                            <div class="action-btn mt-sm-0 mt-15 d-flex align-items-center">
                                @if (hasPermission('account.voucher-contras.create'))
                                    <a href="{{ route('account.voucher-contras.create') }}" class="btn px-20 btn-primary btn-sm">
            ...
            <div class="row">
                <div class="col-md-12" style="padding-bottom: 20px">
                    <div class="row" style="width: 100%">
                        <div class="col-md-6">
                            <h4 class="text-capitalize breadcrumb-title">{{ trans('Contra Vouchers List') }}</h4>
                        </div>
                    </div>
                </div>
                <div class="col-md-12">
...
<td class="text-center">{{ ($vouchers->currentPage() - 1) * $vouchers->perPage() + $loop->iteration  }}</td>
                                                        ...
                                                        <td class="text-center">
                                                            <div class="btn-group btn-corner">
                                                                ...
                                                                <a href="{{ route('account.voucher-contras.show', $item->id) }}" 
                                                                   target="_blank" 
                                                                ...
                                                                @if(!$item->is_approved)
                                                                    @if(hasPermission("account.voucher-contras.approve"))
                                                                        <a href="{{ route('account.voucher-contras.edit', $item->id) }}?type=approve" 
                                                                           target="_blank" 
                                                                    ...
                                                                    @if(hasPermission("account.voucher-contras.update"))
                                                                        <a href="{{ route('account.voucher-contras.edit', $item->id) }}" 
                                                                ...
                                                                @if(hasPermission("account.voucher-contras.destroy"))
                                                                    <button type="button" 
                                                                            data-action="{{ route('account.voucher-contras.destroy', $item->id) }}" 
