...
@section('description', 'Contra Voucher')
@extends('layout.app')
        ...
        <div class="social-dash-wrap">
            ...
            <div class="row">
                <div class="col-md-12 m-2">
                    <h4 class="text-capitalize breadcrumb-title">{{ trans('Contra Voucher') }}</h4>
                    <x-error-alart />
                </div>
                <div class="col-md-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            <form id="form" action="{{ route('account.voucher-contras.store') }}" method="post" enctype="multipart/form-data">
                                @csrf
