...
@section('description', 'Payment Voucher')
@extends('layout.app')
        ...
        <div class="social-dash-wrap">
            ...
            <div class="row">
                <div class="col-md-12 m-2">
                    <h4 class="text-capitalize breadcrumb-title">{{ trans('Payment Voucher') }}</h4>
                    <x-error-alart />
                </div>
                <div class="col-md-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            <form id="form" action="{{ route('account.voucher-payments.store') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input name="total_debit" readonly value="{{ old('total_debit') }}"
                                                                     class="total-debit text-right form-control"
                                                                    style="border: none;">
                                                            </td>
                                                            <td>
                                                                <input name="total_credit" readonly 
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="input-group " style="width: 100%!important; float: left; ">
                                                    <span class="input-group-text">Narration/Description <span class="text-danger">*</span></span>
                                                    <input type="text" required class="form-control" name="description"
                                                        value="{{ old('description') }}" placeholder="Narration / Description" required>
