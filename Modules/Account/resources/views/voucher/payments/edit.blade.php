...
@section('description', 'Edit Payment Voucher')
@extends('layout.app')
        ...
        <div class="social-dash-wrap">
            ...
            <div class="row">
                <div class="col-md-12 m-2">
                    <h4 class="text-capitalize breadcrumb-title">{{ trans('Edit Payment Voucher') }}</h4>
                    <x-error-alart />
                </div>
                <div class="col-md-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            <form id="form" action="{{ route('account.voucher-payments.update', $voucher->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                        ...
                                        <div class="row mt-4 mb-4">
                                            ...
                                            <div class="col-sm-5 my-1">
                                                <div class="input-group">
                                                    ...
                                                    <input name="reference" value="{{ old('reference', $voucher->reference) }}" class="form-control"
                                                        type="text">
                                                </div>
                                            </div>
                                            <div class="col-sm-2 my-1">
                                                <div class="input-group">
                                                    ...
                                                    <input name="date" class="form-control date-picker text-center" type="text"
                                                        value="{{ old('date', $voucher->date) }}" data-date-format="yyyy-mm-dd">
                                        ...
                                        <div class="row mt-2">
                                            <div class="col-sm-12">
                                                <table id="myTable" class="table table-bordered order-list">
                                                    ...
                                                    <tbody>
                                                        @foreach ($voucher->details as $key => $line)
                                                            <tr>
                                                                    ...
                                                                    <div class="col-sm-12">
                                                                        <select required="required" name="account_ids[]"
                                                                            ...
                                                                            @foreach ($accounts as $id => $value)
                                                                                <option value="{{ $value->id }}" {{ $line->account_id == $value->id ? 'selected' : '' }}>
                                                                ...
                                                                <td>
                                                                    <input name="debit[]" value="{{ $line->balance_type == 'Debit' ? numberFormat($line->amount) : '' }}"
                                                                ...
                                                                <td>
                                                                    <input name="credit[]" value="{{ $line->balance_type == 'Credit' ? numberFormat($line->amount) : '' }}"
                                                                        type="text" onclick="enableMe(this)"
                                                    ...
                                                    <tfoot>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input name="total_debit" readonly value="{{ old('total_debit', $voucher->total_debit) }}"
                                                                    disabled class="total-debit text-right form-control"
                                                                    style="border: none;">
                                                            </td>
                                                            <td>
                                                                <input name="total_credit" readonly disabled
                                                                    value="{{ old('total_credit', $voucher->total_credit) }}"
                                            ...
                                            <div class="col-sm-12">
                                                <div class="input-group " style="width: 100%!important; float: left; ">
                                                    ...
                                                    <input type="text" required class="form-control" name="description"
                                                        value="{{ old('description', $voucher->description) }}" placeholder="Narration / Description">
                                        ...
                                        <div class="row mt-2">
                                            ...
                                            <div class="button-group d-flex pt-25 justify-content-md-end justify-content-start">
                                                <div class="btn-group">
                                                    ...
                                                    @if(hasPermission("account.voucher-payments.approve") && request('type') == 'approve')
...
<script>
    ...
    $(document).ready(function() {
        calculateAmount();
        let rowCount = {{ count($voucher->details) }}; // Initialize with number of existing lines
