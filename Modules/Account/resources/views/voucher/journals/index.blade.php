                        ...
                        <div class="breadcrumb-main__wrapper">
                            <div class="action-btn mt-sm-0 mt-15 d-flex align-items-center">
                                @if (hasPermission('account.voucher-journals.create'))
                                    <a href="{{ route('account.voucher-journals.create') }}" class="btn px-20 btn-primary btn-sm">
            ...
            <div class="row">
                <div class="col-md-12" style="padding-bottom: 20px">
                    <div class="row" style="width: 100%">
                        <div class="col-md-6">
                            <h4 class="text-capitalize breadcrumb-title">{{ trans('Journal Vouchers List') }}</h4>
                        </div>
                    </div>
                </div>
                <div class="col-md-12">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <div class="btn-group btn-corner">
                                                                ...
                                                                <a href="{{ route('account.voucher-journals.show', $item->id) }}" 
                                                                   target="_blank" 
                                                                ...
                                                                @if(!$item->is_approved)
                                                                    ...
                                                                    @if(hasPermission("account.voucher-journals.approve"))
                                                                        <a href="{{ route('account.voucher-journals.edit', $item->id) }}?type=approve"
                                                                           target="_blank"
                                                                           class="btn btn-success btn-xs"
                                                                    ...
                                                                    @if(hasPermission("account.voucher-journals.update"))
                                                                        <a href="{{ route('account.voucher-journals.edit', $item->id) }}"
                                                                ...
                                                                @if(hasPermission("account.voucher-journals.destroy"))
                                                                    <button type="button" 
                                                                            data-action="{{ route('account.voucher-journals.destroy', $item->id) }}" 
