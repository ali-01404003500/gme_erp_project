...
@section('title', 'Payment Voucher Detail')


@section('page-header')
    <i class="fa fa-info-circle"></i> Payment Voucher Detail
@stop
        ...
        <div class="col-sm-12">
            ...
            <div class="widget-box widget-color-white ui-sortable-handle clearfix" id="widget-box-7" style="width: 90%; margin-left: 5%; margin-top: 30px">
                ...
                <div class="widget-header widget-header-small">
                    ...
                    <div class="widget-toolbar">
                        <a href="{{ route('account.voucher-payments.index') }}" ><i class="fa fa-list-alt"></i> List</a>
                    </div>

                    <div class="widget-toolbar">
                        <a href="{{ route('account.voucher-payments.create') }}" ><i class="fa fa-plus"></i> Create</a>
                    </div>
                </div>
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <th class="pl-3 text-right">{{ number_format($totalAmount) }}</th>
                                    <th class="pl-3 text-right">{{ number_format($totalAmount) }}</th>
                                </tr>
                            </tfoot>
                        </table>
                ...
                @if(request('type') == 'approve' && !$voucher->is_approved)
                    <div class="row" style="width: 100%; margin: 0 !important; padding-bottom: 15px">
                        <div class="col-md-12 text-right">
                            <form action="{{ route('account.voucher-payments.approve', $voucher->id) }}" method="post">
                                @csrf
