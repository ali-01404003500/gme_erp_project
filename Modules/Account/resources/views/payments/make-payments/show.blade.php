        ...
        <div class="social-dash-wrap">
                        ...
                        <div class="breadcrumb-action justify-content-center flex-wrap">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('account.payments.make-payments.index') }}">Payments List</a></li>
            ...
            <div class="row">
                <div class="d-flex justify-content-between align-items-center user-member__title mb-30">
                    <h3 class="text-capitalize">Money Receipt</h3>
                    
                    <div class="action-buttons no-print">
                        <a href="{{ route('account.payments.make-payments.index') }}" class="btn btn-secondary btn-sm">
                        ...
                        <div class="card-body">
                                ...
                                <div class="right">
                                    <table>
                                        <tr>
                                            <th>Date</th>
                                            <td>:</td>
                                            <td>{{ \Carbon\Carbon::parse($makePayment->date)->format('d-M-Y') }}</td>
                                        </tr>
                                        <tr>
                                            <th>Prepared By</th>
                                            <td>:</td>
                            ...
                            <section class="invoice-details">
                                <table>
                                    ...
                                    <tbody>
                                        @php $sn = 1; @endphp
                                        @foreach ($makePayment->paymentDetails as $detail)
                                            <tr>
                                                <td>{{ $sn++ }}</td>
                                                <td>
                                                    ...
                                                    @if ($detail->transaction_id)
                                                        <br><small><strong>TXN:</strong> {{ $detail->transaction_id }}</small>
                                                    @endif
                                                </td>
                                ...
                                <section class="requisition-info" style="display: flex; justify-content: space-between;">
                                    <div class="left" style="width: 70%;">
                                        <p>IN WORD : {{ $makePayment->amount_in_words ?? convert_number($makePayment->amount) }} Taka Only</p>
                                    </div>
