                ...
                <form action="{{route('account.fund-transfers.store')}}" method="post">
                    ...
                    <div class="row" style="width: 100%; margin: 0 0 20px !important;">
                        <div class="col-sm-12 px-4">
                            ...
                            <!-- Date -->
                        @include('Account::includes.inputs.date-field', ['name' => 'date', 'is_required' => 'required'])
                        ...
                        <!-- From Account -->
                            ...
                            <!-- Description -->
                        @include('Account::includes.inputs.input-field', ['name' => 'description', 'is_required' => 1])

                        <!-- Reference -->
                        @include('Account::includes.inputs.input-field', ['name' => 'reference'])

                        <!-- Amount -->
                        @include('Account::includes.inputs.input-field', ['name' => 'amount', 'is_number' => true, 'is_required' => 1])
