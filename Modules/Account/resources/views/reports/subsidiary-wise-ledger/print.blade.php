                        ...
                        <tbody>
                            ...
                            @foreach($transactions as $transaction)
                                ...
                                <tr>
                                    ...
                                    <td class="text-right pr-1">{{ number_format($transaction->amount < 0 ? abs($transaction->amount) : 0) }}</td>
                                    <td class="text-right pr-1">{{ number_format($transaction->amount >= 0 ? $transaction->amount : 0) }}</td>
                                </tr>
                            @endforeach
                        </tbody>
