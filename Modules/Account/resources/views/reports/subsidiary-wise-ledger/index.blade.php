            ...
            <div class="widget-box widget-color-white ui-sortable-handle clearfix" id="widget-box-7">
                ...
                <form action="" method="get">
                    <div class="row px-3 pb-2" style="width: 100%; margin: 0 !important;">
                        ...
                        <div class="col-sm-5">
                            @include('Account::includes.input-groups.select-group', ['modelVariable' => 'accountSubsidiaries',
                            'edit_id' => request('account_subsidiary_id')])
                        </div>

                        <div class="col-sm-3">
                            @include('Account::includes.input-groups.date-range', ['date1' => request('from',date('Y-m-d')), 'date2'
