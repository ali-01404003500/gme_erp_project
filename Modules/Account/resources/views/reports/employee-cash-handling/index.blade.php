                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                ...
                                                <a href="javascript:void(0)"
                                                   class="employee-balance"

                                                   data-name="{{ $dataItem['name'] }}"

                                                   data-balance="{{ $dataItem['balance'] }}"

                                                   data-transactions='@json($dataItem["transactions"])'>
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title"
                    ...
                    Employee Cash Transaction Details
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 text-right">
                        ...
                        <span id="modal_employee_balance">
                        </span>
    ...
    transactions.forEach(function (transaction, index) {
        ...
        let type =
            transaction.balance_type
                ? transaction.balance_type.toUpperCase()
                : '';
