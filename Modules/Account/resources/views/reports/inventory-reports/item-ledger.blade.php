                        ...
                        @if (isset($item_stock_details))
                            ...
                            @forelse ($item_stock_details as $key => $details)
                                <tr>
                                    ...
                                    <td class="text-center">{{ number_format($opening_qty ?? 0)  }}</td>
                                    <td class="text-right">{{ number_format($opening_cost) }}</td>
                                    ...
                                    @if ($details->type == "Prod Purchase Receive" || $details->type == "Purchase Receive")
                                        ...
                                        <td class="text-center">{{ number_format($details->credit_qty) }}</td>
                                        <td class="text-right">{{ number_format($details->credit_rate) }}</td>
                                        <td class="text-right">{{ number_format($details->credit_qty * $details->credit_rate)  }}</td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                    @else
                                        ...
                                        <td></td>
                                        <td>{{ $details->source_number }}</td>
                                        <td class="text-center">{{ number_format($details->debit_qty) }}</td>
                                        <td class="text-right">{{ number_format($details->debit_rate) }}</td>
                                        <td class="text-right">{{ number_format(($details->debit_qty * $details->debit_rate)) }}</td>
                                    @endif
                                    ...
                                    <td>{{ number_format($final_qty ?? 0) }}</td>
                                    <td class="text-right">{{ number_format($final_rate) }}</td>
                                    <td class="text-right">{{ number_format($final_amount) }}</td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">{{ number_format($opening_stock ?? 0) }}</td>
                                    <td class="text-right">{{ number_format($opening_cost) }}</td>
                                    <td class="text-right">{{ number_format($opening_rate) }}</td>
                                    ...
                                    <td class="text-center">{{ number_format($opening_stock ?? 0.00) }}</td>
                                    <td class="text-right">{{ number_format($opening_rate) }}</td>
                                    <td class="text-right">{{ number_format($opening_rate) }}</td>
