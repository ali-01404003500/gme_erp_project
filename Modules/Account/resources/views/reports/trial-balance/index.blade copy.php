    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="widget-box widget-color-white ui-sortable-handle clearfix" id="widget-box-7"
                ...
                <h4 class="text-center d-print">As On {{ request('from') ?? today() }}</h4>
                ...
                <div class="row px-3 pb-2 no-print" style="width: 100%; margin: 0 !important;">
                    <form action="" method="get">
                        ...
                        <div class="col-sm-3">
                            @include('Account::includes.input-groups.date-field', ['date' => $from, 'is_read_only' => true])
                        </div> --}}
                                    ...
                                    <tr style="background: #a8c1c3; color: white;">
                                        ...
                                        @if ($accountGroup->balance_type == 'Debit')
                                            <td width="20%" class="text-right pr-1">
                                                <strong
                                                    style="font-size: 16px">{{ number_format($debitAccountGroup - $creditAccountGroup) }}</strong>
                                            </td>
                                            <td width="20%" class="text-right pr-1">
                                        ...
                                        @else
                                            ...
                                            <td width="20%" class="text-right pr-1">
                                                <strong
                                                    style="font-size: 16px">{{ number_format($creditAccountGroup - $debitAccountGroup) }}</strong>
                                            </td>
                                        @endif
                                            ...
                                            @if ($accountGroup->balance_type == 'Debit')
                                                <td width="20%" class="text-right pr-1">
                                                    <strong class="account-control-debit-account"
                                                        ...
                                                        style="font-size: 15px">{{ number_format($debitAccountControl - $creditAccountControl) }}</strong>
                                                </td>
                                                <td width="20%" class="text-right pr-1">
                                            ...
                                            @else
                                                ...
                                                <td width="20%" class="text-right pr-1">
                                                    <strong class="account-control-credit-account"
                                                        style="font-size: 15px">{{ number_format($creditAccountControl - $debitAccountControl) }}</strong>
                                                </td>
                                            @endif
                                        </tr>
                                                ...
                                                @if ($accountGroup->balance_type == 'Debit')
                                                    <td width="20%" class="text-right pr-1">
                                                        <strong
                                                            ...
                                                            style="font-size: 14px">{{ number_format($accountSubsidiary->accounts->sum('debit') - $accountSubsidiary->accounts->sum('credit')) }} </strong>
                                                    </td>
                                                    <td width="20%" class="text-right pr-1">
                                                ...
                                                @else
                                                    ...
                                                    <td width="20%" class="text-right pr-1">
                                                        <strong
                                                            ...
                                                            style="font-size: 14px">{{ number_format($accountSubsidiary->accounts->sum('credit') - $accountSubsidiary->accounts->sum('debit')) }}</strong>
                                                    </td>
                                                @endif
                                            </tr>
