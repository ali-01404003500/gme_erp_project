                            ...
                            <tbody>
                                ...
                                @foreach ($purchases as $key => $purchase)
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right pr-1">{{ number_format($purchase->paid_amount) }}</td>
                                        <td class="text-right pr-1">{{ number_format($purchase->due_amount) }}</td>
                                        <td class="text-right pr-1">{{ number_format($purchase->total_amount) }}</td>
                                    </tr>
                                @endforeach

                                <tr>
                                    <th class="text-center" colspan="5">Total In Page</th>
                                    <th class="text-right pr-1">{{ number_format($total_paid) }}</th>
                                    <th class="text-right pr-1">{{ number_format($total_due) }}</th>
                                    <th class="text-right pr-1">{{ number_format($total_amount) }}</th>
                                </tr>
