                        ...
                        <table class="table table-bordered table-striped" style="margin-bottom: 0">
                            ...
                            <tbody>
                                ...
                                @foreach ($transaction_purchases as $key => $purchase)
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right pr-1">{{ number_format($total_paid) }}</td>
                                        <td class="text-right pr-1">{{ number_format($total_due) }}</td>
                                        <td class="text-right pr-1">{{ number_format($total_amount) }}</td>
                                    </tr>
                                @endforeach

                                <tr>
                                    <th class="text-center" colspan="5">Total In Page</th>
                                    <th class="text-right pr-1">{{ number_format($grand_total_paid) }}</th>
                                    <th class="text-right pr-1">{{ number_format($grand_total_due) }}</th>
                                    <th class="text-right pr-1">{{ number_format($grand_total_amount) }}</th>
                                </tr>
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <th class="text-right pr-1">{{ number_format($total_purchase_paid) }}</th>
                                    <th class="text-right pr-1">{{ number_format($total_purchase_due) }}</th>
                                    <th class="text-right pr-1">{{ number_format($total_purchase_amount) }}</th>
                                </tr>
                            </tfoot>
