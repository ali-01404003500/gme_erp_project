            ...
            <div class="widget-box widget-color-white ui-sortable-handle clearfix" id="widget-box-7">
                ...
                <form action="">
                    <div class="row px-3" style="width: 100%; margin: 0 !important;">
                        <div class="col-sm-6">
                            @include('Account::includes.input-groups.select-group', ['modelVariable' => 'accountControls', 'edit_id' => request('account_control_id')])
                        </div>
                    ...
                    <div class="row px-3 pt-1 pb-2" style="width: 100%; margin: 0 !important;">
                        ...
                        <div class="col-sm-4">
                            @include('Account::includes.input-groups.date-range', ['is_read_only' => 1, 'is_required' => 1, 'date1' => request('from') ?? date('Y-m-d'), 'date2' => request('to') ?? date('Y-m-d')])
                        </div>
                                                                                ...
                                                                                <th colspan="4">
                                                                                    <div
                                                                                        ...
                                                                                        Total Control Account <span
                                                                                            style="float: right">{{number_format($controlWise->sum('amount'))}}</span>
                                                                                    </div>
                                                                                </th>
                                                                            </tr>
                                                                            </tfoot>
                                                                    ...
                                                                    <th colspan="3">
                                                                        <div
                                                                            ...
                                                                            Total Subsidiary Account <span
                                                                                style="float: right">{{number_format($subWise->sum('amount'))}}</span>
                                                                        </div>
                                                                    </th>
                                                                </tr>
                                                                </tfoot>
                                                    ...
                                                    <th colspan="3">
                                                        <div
                                                            ...
                                                            Date Wise Total Amount <span
                                                                style="float: right">{{number_format($dateWise->sum('amount'))}}</span>
                                                        </div>
                                                    </th>
                                                </tr>
                                                </tfoot>
    ...
    <script>
        $(document).ready(function () {
            ...
            accountControlId.change(function () {
                ...
                $.get('{{route('account.ajax.subsidiaries-and-accounts-by-control')}}?account_control_id='+$(this).val(), function (res) {
            ...
            accountSubsidiaryId.change(function () {
                ...
                $.get(`{{route('account.ajax.accounts-by-control-and-subsidiary')}}?account_control_id=${accountControlId.val()}&account_subsidiary_id=${$(this).val()}`, function (res) {
