    ...
    <div class="row">
        ...
        <div class="col-sm-12" style="z-index: 999;">
            <div class="btn-group btn-corner mt-2 pull-right no-print">
                <a href="{{ route('account.report.transaction-ledger') }}" class="btn btn-danger btn-minier">
                        ...
                        <table class="table table-bordered table-striped" style="margin-bottom: 0; margin-left: 10%; width: 85%; border: none !important">
                            ...
                            @foreach($accountGroup->accounts->where('balance', '<>', 0)->sortBy('name') as $account)
                                <tr>
                                    ...
                                    <td style="border: none !important" width="150px" class="text-right pr-1">{{ number_format($account->balance ?? 0) }}</td>
                                </tr>
                            @endforeach
                            <tr>
                                ...
                                <td style="border: none !important" class="text-right pr-1" width="20%">{{ number_format($totalBalance = $accountGroup->accounts->sum('balance')) }}</td>
                            </tr>
                            ...
                            @if($loop->last)
                                <tr>
                                    ...
                                    <td class="text-right pr-1" width="20%" style="border-top: 1px solid black !important;border-bottom: none !important; border-left: none !important; border-right: none !important;">{{ number_format($totalOwnerEquity) }}</td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-right pr-1" width="20%" style="border: none !important;">{{ number_format($currentEquity = ($asset - $totalOwnerEquity)) }}</td>
                                </tr>
                                <tr>
                                    <td class="text-right" style="border-top: 1px solid black !important;border-bottom: none !important; border-left: none !important; border-right: none !important;">
                                        <strong style="font-size: 17px; font-weight: bolder; letter-spacing: -1px !important;">
                                    ...
                                    <td class="text-right pr-1" style="border-top: 1px solid black !important;border-bottom: none !important; border-left: none !important; border-right: none !important;">{{ number_format($totalOwnerEquity + $currentEquity) }}</td>
                                </tr>
                            @endif
                            </tbody>
                        </table>
