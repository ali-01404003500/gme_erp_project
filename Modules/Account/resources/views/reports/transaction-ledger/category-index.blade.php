                ...
                <div class="row px-3 pb-2" style="width: 100%; margin: 0 !important;">
                    <form action="" method="get">
                        ...
                        <div class="col-sm-4 col-sm-offset-3">
                            @include('Account::includes.input-groups.date-range', ['date1' => $from, 'date2' => $to, 'is_read_only' => true])
                        </div>
                        ...
                        <table class="table table-bordered table-striped" style="margin-bottom: 0">
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <th class="text-right pr-1">{{ number_format(abs($totalOpeningBalance)) }}</th>
                                    <th class="text-right pr-1">{{ number_format(abs($totalDebit)) }}</th>
                                    <th class="text-right pr-1">{{ number_format($totalCredit) }}</th>
                                    <th class="text-right pr-1">{{ number_format(($totalOpeningBalance + $totalDebit + $totalCredit)) }}</th>
                                </tr>
                            </tfoot>
                        </table>
                        <br>
