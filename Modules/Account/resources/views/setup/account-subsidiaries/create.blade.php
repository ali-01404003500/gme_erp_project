    ...
    <div class="row">
        ...
        <!-- heading -->
            <div class="widget-box widget-color-white ui-sortable-handle clearfix" id="widget-box-7">
                ...
                <!-- INPUTS -->
                <form action="{{route('account.account-subsidiaries.store')}}" method="post">
                    @csrf
                    <div class="row" style="width: 100%; margin: 0 0 20px !important;">
                        <div class="col-sm-12 px-4">
                            <!-- Account Group -->
                            @include('Account::includes.inputs.option-select', ['modelVariable' => 'accountGroups', 'is_required' => true])

                            <!-- Account Controls -->
                            @include('Account::includes.inputs.option-select', ['modelVariable' => 'accountControls', 'is_required' => true])
