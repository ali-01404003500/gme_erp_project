                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">
                                        {{ trans('menu.account-setup-banks-menu-title') }}</li>
                                </ol>
                            </nav>
                        </div>
                        <div class="breadcrumb-main__wrapper">
                            <div class="action-btn mt-sm-0 mt-15">
                                @if (hasPermission('account.account-setup.banks.create'))
            ...
            <div class="row">
                <div class="col-md-12" style="padding-bottom: 20px">
                    <div class="row" style="width: 100%">
                        <div class="col-md-6">
                            <h4 class="text-capitalize breadcrumb-title">{{ trans('menu.account-setup-banks-menu-title') }}
                            </h4>
                        </div>
                        <x-error-alart />
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center text-wrap">
                                                <div class="btn-group btn-group-sm" role="group"
                                                    ...
                                                    @if (hasPermission('account.account-setup.banks.update'))
                                                        <button type="button" data-action="{{ route('account.account-setup.banks.update', $bank->id) }}" data-data="{{$bank}}" class="btn btn-outline-primary btn-edit" data-toggle="tooltip" data-placement="top" title="Edit"
                                                    ...
                                                    @if (hasPermission('account.account-setup.banks.destroy'))
                                                        <button type="button"
                                                            data-action="{{ route('account.account-setup.banks.destroy', $bank->id) }}"
                    ...
                    <div class="modal-dialog modal-md" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-header" id="createModalLabel">
                                <h5 class="modal-title">{{ trans('menu.account-setup-banks-menu-title') }}</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                    aria-hidden="true"></button>
                            </div>
                            <form action="{{ route('account.account-setup.banks.store') }}" method="post">
                                @csrf
