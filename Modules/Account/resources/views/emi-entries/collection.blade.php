...
@section('content')
                            ...
                            <div class="mt-40 mb-50">
                                ...
                                <div class="card mb-4 d-none" id="emiDetailsCard">
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="btn-group">
                                            <button class="btn btn-danger btn-sm me-2" id="early-settlement-btn">Early
                                                Settlement</button>
                                            <button class="btn btn-primary btn-sm reschedule-btn" data-bs-toggle="modal"
                                                data-bs-target="#rescheduleEmiModal">Reschedule</button>
                                        </div>
                                    </div>
    ...
    <div class="modal fade" id="emiCollectionModal" tabindex="-1" aria-labelledby="emiCollectionModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="emiCollectionModalLabel"><i class="fas fa-money-bill-wave me-2"></i>EMI
                        Collection</h5>
                        ...
                        <div class="payment-section table-responsive border p-3">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-3 mb-2">
                                    <label for="input-pay-mode" class="form-label">Pay Mode <span
                                ...
                                <div class="col-md-3 mb-2">
                                    <label for="input-date" class="form-label">Date <span
                                            class="text-danger">*</span></label>
                                    <input type="text" id="input-date" value="{{ date('Y-m-d') }}"
                                        class="form-control flatdate">
                                </div>
                                <div class="col-md-3 mb-2">
                                    <label for="input-amount" class="form-label">Amount <span
                                            class="text-danger">*</span></label>
                                    <input type="number" id="input-amount" class="form-control" placeholder="Amount"
                                        step="0.01" min="0">
                                </div>
                                <div class="col-md-3">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-9 mb-2">
                                    <label for="input-remark" class="form-label">Remark <span
                                            class="text-danger">*</span></label>
                                    <textarea id="input-remark" class="form-control" rows="2"
                                        placeholder="Enter remark here"></textarea>
                                </div>
                                <div class="col-md-3 mb-2 d-flex align-items-end">
                                    <button type="button" id="add-payment" class="btn btn-success w-100"><i
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-success" id="save-collection"><i class="fas fa-save me-2"></i>Save
                        Collection</button>
                </div>
            </div>
        </div>
                ...
                <div class="modal-body">
                    <form id="earlySettlementForm">
                        ...
                        <div class="payment-section table-responsive border p-3">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-3 mb-2">
                                    <label for="settlement-input-pay-mode" class="form-label">Pay Mode <span
                                            class="text-danger">*</span></label>
                                ...
                                <div class="col-md-3 mb-2 pay-field txn-field d-none">
                                    ...
                                    <input type="text" id="settlement-input-txn" class="form-control"
                                        placeholder="Transaction ID">
                                </div>
                                <div class="col-md-3 mb-2">
                                    <label for="settlement-input-date" class="form-label">Date <span
                                            class="text-danger">*</span></label>
                                    <input type="text" id="settlement-input-date" value="{{ date('Y-m-d') }}"
                                        class="form-control flatdate">
                                </div>
                                <div class="col-md-3 mb-2">
                                    <label for="settlement-input-amount" class="form-label">Amount <span
                                            class="text-danger">*</span></label>
                                    <input type="number" id="settlement-input-amount" class="form-control"
                            ...
                            <div class="row mb-3">
                                <div class="col-md-9 mb-2">
                                    <label for="settlement-input-remark" class="form-label">Remark <span
                                            class="text-danger">*</span></label>
                                    <textarea id="settlement-input-remark" class="form-control" rows="2"
                                        placeholder="Enter remark here"></textarea>
                                </div>
                                <div class="col-md-3 mb-2 d-flex align-items-end">
                                    <button type="button" id="settlement-add-payment" class="btn btn-success w-100"><i
                                            class="fa fa-plus"></i> Add Payment</button>
                                </div>
                            </div>
                            ...
                            <table class="table table-bordered" id="settlement-payment-table">
                                ...
                                <tfoot>
                                    <tr>
                                        <td colspan="5" class="text-end fw-bold">Total:</td>
                                        <td colspan="3" class="fw-bold text-primary" id="settlement-total-display">৳
                                            <span>0.00</span>
                                    ...
                                    <tr>
                                        <td colspan="5" class="text-end fw-bold">Payable:</td>
                                        <td colspan="3" class="fw-bold text-primary" id="settlement-total-payable">৳
                                            <span>0.00</span>
                                    ...
                                    <tr>
                                        <td colspan="5" class="text-end fw-bold">Due:</td>
                                        <td colspan="3" class="fw-bold text-danger" id="settlement-total-due">৳
                                            <span>0.00</span>
                                    ...
                                    <tr>
                                        <td colspan="5" class="text-end fw-bold">Advance:</td>
                                        <td colspan="3" class="fw-bold text-success" id="settlement-total-advance">৳
                                            <span>0.00</span>
    ...
    <div class="modal fade" id="rescheduleEmiModal" tabindex="-1" aria-labelledby="rescheduleEmiModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="remaining_principal" class="form-label">Remaining
                                                    Principal</label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="remaining_interest" class="form-label">Remaining
                                                    Interest</label>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="reschedule_interest_rate" class="form-label">Interest Rate
                                                    (%)</label>
                                                <input type="number" id="reschedule_interest_rate" name="interest_rate"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="schedule_date" name="schedule_date"
                                                    value="{{ date('Y-m-d') }}" class="form-control flatdate" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select id="tenure_type" name="tenure_type" class="form-select tom-select"
                                                    required>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" id="tenure_no" name="tenure_no" class="form-control"
                                                    min="1" required>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-12 text-center">
                                                    ...
                                                    <button type="button" id="generate-reschedule"
    ...
    resetModalInputs(prefix);
        ...
        function saveEmiCollection() {
            ...
            $.ajax({
                ...
                url: "{{route('account.emi-collections.collection-store')}}",
                type: "POST",
                data: formData,
                processData: false,
                contentType: false,
        ...
        function saveEarlySettlement() {
            ...
            $.ajax({
                url: "{{route('account.emi-collections.settlement-collection-store')}}",
                type: "POST",
                data: formData,
                processData: false,
                contentType: false,
