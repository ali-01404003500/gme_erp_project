            ...
            <div class="widget-box widget-color-white ui-sortable-handle clearfix" id="widget-box-7">
                ...
                <div class="widget-header widget-header-small">
                    ...
                    <div class="widget-toolbar">
                        <a href="{{ route('account.acc-purchase-returns.index') }}" ><i class="fa fa-refresh"></i> Refresh</a>
                    </div>

                    <div class="widget-toolbar">
                        <a href="{{ route('account.acc-purchase-returns.create') }}" ><i class="fa fa-plus"></i> Create</a>
                    </div>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group btn-corner">
                                                ...
                                                <a href="{{route('account.acc-purchase-returns.show', $purchaseReturn->id)}}" target="_blank" class="btn btn-success btn-xs" title="View Details">
                                                    <i class="fa fa-eye"></i>
                                                </a>

                                                @if(hasPermission("account-purchases.delete", $slugs))
                                                    <button type="button" onclick="delete_item(`{{ route('account.acc-purchase-returns.destroy', $purchaseReturn->id) }}`)" class="btn btn-xs btn-danger" title="Delete">
