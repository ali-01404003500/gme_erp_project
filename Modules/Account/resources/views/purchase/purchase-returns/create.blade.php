            ...
            <div class="widget-box widget-color-white ui-sortable-handle clearfix" id="widget-box-7">
                ...
                <div class="widget-header widget-header-small">
                    ...
                    <div class="widget-toolbar">
                        <a href="{{ route('account.acc-purchase-returns.index') }}" ><i class="fa fa-list-alt"></i> List</a>
                    </div>
                ...
                <div class="widget-body">
                    <div class="widget-main">
                        <form class="form-horizontal" action="{{ route('account.acc-purchase-returns.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3 my-1">
                                    <div class="input-group">
                                        ...
                                        <select required name="supplier_id" class="chosen-select-100-percent select-supplier" data-placeholder="- Select Supplier -">
                                            <option></option>
                                ...
                                <div class="col-sm-4 my-1">
                                    <div class="input-group">
                                        ...
                                        <select required name="purchase_id" class="chosen-select-100-percent select-invoice" data-placeholder="- Select Invoice -">
                                            <option></option>
                                ...
                                <div class="col-sm-12 mt-3">
                                    ...
                                    <table id="myTable" class="table table-bordered order-list">
                                        ...
                                        <tfoot>
                                            <tr>
                                                <td colspan="5" class="text-right item-serial">Total</td>
                                                <td>
...
@section('js')
    ...
    <script>
        ...
        const url_returnable_purchase_invoices  = "{{ route('account.acc-returnable-purchase-invoices') }}"
        const url_returnable_purchase_items     = "{{ route('account.acc-returnable-purchase-items') }}"
        ...
        $('.select-supplier').change(function() {
            ...
            if(supplier_id != '')
            {
                $.get(url_returnable_purchase_invoices, {
        ...
        $('.select-invoice').change(function() {
            ...
            if(purchase_id != '')
            {
                $.get(url_returnable_purchase_items, {
                    purchase_id: purchase_id
                })
                .then(function(data) {

                    $('.returnable-purchase-items').html(data)
                })
            }
        })
    </script>
