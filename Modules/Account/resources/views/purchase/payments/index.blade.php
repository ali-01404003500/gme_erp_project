                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group btn-corner">
                                    ...
                                    <a href="{{route('account.acc_purchases.show', $value->id)}}" target="_blank"
                                        class="btn btn-success btn-xs" title="View Details"><i
                                            class="fa fa-eye"></i></a>
                                    @if(hasPermission("acc_purchases.edit", $slugs))
                                    <a href="{{route('account.acc_purchases.edit', $value->id)}}" class="btn btn-primary btn-xs"
                                        title="Edit"><i class="fa fa-pencil"></i></a>
                                    @endif
                                    @if(hasPermission("acc_purchases.delete", $slugs))
                                    <a href="#"
                                        onclick="delete_item('{{ route('account.acc_purchases.destroy', $value->id) }}')"
