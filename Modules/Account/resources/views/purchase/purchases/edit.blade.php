            ...
            <div class="widget-box widget-color-white ui-sortable-handle clearfix" id="widget-box-7">
                ...
                <div class="widget-header widget-header-small">
                    ...
                    <div class="widget-toolbar">
                        <a href="{{ route('account.acc-purchases.index') }}" ><i class="fa fa-list-alt"></i> List</a>
                    </div>
                ...
                <div class="widget-body">
                    <div class="widget-main">
                        <form class="form-horizontal" action="{{ route('account.acc-purchases.update', $purchase->id) }}" method="post" enctype="multipart/form-data">
