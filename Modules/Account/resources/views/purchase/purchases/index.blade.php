            ...
            <div class="widget-box widget-color-white ui-sortable-handle clearfix" id="widget-box-7">
                ...
                <div class="widget-header widget-header-small">
                    ...
                    <div class="widget-toolbar">
                        <a href="{{ route('account.acc-purchases.index') }}" ><i class="fa fa-refresh"></i> Refresh</a>
                    </div>

                    <div class="widget-toolbar">
                        <a href="{{ route('account.acc-purchases.create') }}" ><i class="fa fa-plus"></i> Create</a>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group btn-corner">
                                                ...
                                                <a href="{{route('account.acc-purchases.show', $purchase->id)}}" target="_blank" class="btn btn-success btn-minier" title="View Details">
                                                    <i class="fa fa-eye"></i>
                                                </a>

                                                @if(hasPermission("account-purchases.delete", $slugs) && $purchase->source == 'Account')
                                                    <button type="button" onclick="delete_item(`{{ route('account.acc-purchases.destroy', $purchase->id) }}`)" class="btn btn-minier btn-danger" title="Delete">
