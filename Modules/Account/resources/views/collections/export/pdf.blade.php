...
<head>
    ...
    <title>Collection Receipt - {{ $collection->collection_id }}</title>
    <style>
        body {
...
<body>
    <div class="invoice-container">
        ...
        <header class="my-header">
            @include('partials._for_pdf_header_with_qr', ['qrCode' => true, 'qrCodeUrl' => route('account.collections.collections.show', $collection->id)])
        </header>
            ...
            <div class="left">
                <table>
                    <tr>
                        ...
                        <td style="width: 5%;">:</td>
                        <td style="width: 65%;">{{ $collection->collection_id }}</td>
                    </tr>
                    <tr>
                        <th>Customer Name</th>
                        <td>:</td>
                        <td>{{ $collection->collectionFrom->company_name ?? $collection->collectionFrom->name ?? 'N/A' }}</td>
                    </tr>
                    <tr>
                        <th>Address</th>
                        <td>:</td>
            ...
            <div class="right">
                <table>
                    <tr>
                        ...
                        <td style="width: 5%;">:</td>
                        <td style="width: 55%;">{{ \Carbon\Carbon::parse($collection->collection_date)->format('d-m-Y') ?? now()->format('d-M-Y') }}</td>
                    </tr>
                    <tr>
                        <th>Prepared By</th>
                        <td>:</td>
                ...
                <div class="signature-box left">
                    <div class="signature-display">
                        @if (@$collection->signature->signature)
                            <img src="{{ @$collection->signature->signature }}" alt="Receiver Signature">
