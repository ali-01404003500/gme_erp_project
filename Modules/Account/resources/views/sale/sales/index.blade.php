            ...
            <div class="widget-box widget-color-white ui-sortable-handle clearfix" id="widget-box-7">
                ...
                <div class="widget-header widget-header-small">
                    ...
                    <div class="widget-toolbar">
                        <a href="{{ route('account.acc-sales.index') }}" ><i class="fa fa-refresh"></i> Refresh</a>
                    </div>

                    <div class="widget-toolbar">
                        <a href="{{ route('account.acc-sales.create') }}" ><i class="fa fa-plus"></i> Create</a>
                    </div>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group btn-corner">
                                                ...
                                                <a href="{{route('account.acc-sales.show', $sale->id)}}" target="_blank" class="btn btn-success btn-xs" title="View Details">
                                                    <i class="fa fa-eye"></i>
                                                </a>

                                                @if(hasPermission("account-sales.delete", $slugs))
                                                    <button type="button" onclick="delete_item(`{{ route('account.acc-sales.destroy', $sale->id) }}`)" class="btn btn-xs btn-danger" title="Delete">
