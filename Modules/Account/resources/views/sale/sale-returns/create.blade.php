            ...
            <div class="widget-box widget-color-white ui-sortable-handle clearfix" id="widget-box-7">
                ...
                <div class="widget-header widget-header-small">
                    ...
                    <div class="widget-toolbar">
                        <a href="{{ route('account.acc-sale-returns.index') }}" ><i class="fa fa-list-alt"></i> List</a>
                    </div>
                ...
                <div class="widget-body">
                    <div class="widget-main">
                        <form class="form-horizontal" action="{{ route('account.acc-sale-returns.store') }}" method="post" enctype="multipart/form-data">
...
@section('js')
    ...
    <script>
        ...
        const url_returnable_sale_invoices  = "{{ route('account.acc-returnable-sale-invoices') }}"
        const url_returnable_sale_items     = "{{ route('account.acc-returnable-sale-items') }}"
