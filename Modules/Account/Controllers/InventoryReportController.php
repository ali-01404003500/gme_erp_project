...
use Modules\Account\Models\ProductStock;
use Modules\Account\Models\ProductStockDetail;
...
class InventoryReportController extends Controller
{
    ...
    public function getStockInHand(Request $request)
    {
        ...
        return view('Account::reports.inventory-reports.stock-in-hand', $data);
    }
    ...
    public function getItemLedger(Request $request)
    {
        ...
        if ($request->filled('product_id')) {
            ...
            return view('Account::reports.inventory-reports.item-ledger', compact('item_stock_details', 'companies', 'items', 'selected_item', 'opening_stock', 'opening_rate'));

        } else {

            return view('Account::reports.inventory-reports.item-ledger', compact('companies', 'items'));
