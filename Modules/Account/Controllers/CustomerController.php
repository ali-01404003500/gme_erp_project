...
class CustomerController extends Controller
{
    ...
    */
    ...
    public function index()
    {
        ...
        return view('Account::party.customers.index', compact('customers'));
    }
    ...
    public function create()
    {
        ...
        return view('Account::party.customers.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('account.acc-customers.index')->with('success', 'Customer Create Successful');
    ...
    public function edit($id)
    {
        ...
        return view('Account::party.customers.edit', compact('customer'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect()->route('account.acc-customers.index')->with('success', 'Customer Update Successful');
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            return redirect()->route('account.acc-customers.index')->with('success', 'Customer Successfully Deleted!');
