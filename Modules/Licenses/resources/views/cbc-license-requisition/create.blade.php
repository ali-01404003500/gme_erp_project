@section('title', 'CBC License Requisition Create')
@section('description', 'CBC License Requisition Create')
@extends('layout.app')
@section('content')
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">
                                        {{ trans('menu.create-cbc-license-requisition-menu-title') }}</li>
                                </ol>
                            </nav>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12 m-2">
                    <h4 class="text-capitalize breadcrumb-title">
                        {{ trans('menu.create-cbc-license-requisition-menu-title') }}
                    </h4>
                    <x-error-alart />
                </div>
                <div class="col-md-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            <form action="{{ route('licenses.cbc-license-requisitions.store') }}" method="POST"
    ...
    $(document).ready(function() {
        flatpickr('#expired_date', {
                ...
                if (customerId) {
                    $.ajax({
                        type: "GET",
                        url: "{{ route('licenses.cbc.getDongleIds') }}",
...
<script>
   ...
   $('#dongle_id').on('change', function() {
           ...
           if (dongleId) {
               $.ajax({
                   type: "GET",
                   url: "{{ route('licenses.cbc.getNotes') }}",
                   data: { 
