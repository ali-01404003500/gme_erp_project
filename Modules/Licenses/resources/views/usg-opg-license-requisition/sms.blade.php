@section('title', 'USG OPG License Requisition SMS Send')
@section('description', 'USG OPG License Requisition SMS Send')
@extends('layout.app')
@section('content')
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">
                                        {{ trans('USG OPG License Requisition SMS Send') }}</li>
                                </ol>
                            </nav>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12 m-2">
                    <h4 class="text-capitalize breadcrumb-title">
                        {{ trans('USG OPG License Requisition SMS Send') }}
                    </h4>
                    <x-error-alart />
                </div>
                <div class="col-md-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            <form action="{{ route('licenses.usg-opg-sms.store')}}" method="POST"
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-4 mt-4">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="u_s_g_or_o_p_g_license_requisition_id" class="form-control" value="{{ $license->id}}">
                                        </div>
                                    </div>
                                    <div class="col-md-4 mt-4">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <div class="button-group d-flex pt-25 justify-content-md-end justify-content-start">
                                            <button type="submit" name="status" value="Send" id="sendButton"  class="btn btn-success btn-sm">Send</button>
                                            <button type="submit" name="status" value="Deny" id="denyButton" class="btn btn-danger btn-sm">Deny</button>
                                            <a href="{{ route('licenses.usg-opg-license-requisitions.index') }}" class="btn btn-primary btn-sm">Back</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
