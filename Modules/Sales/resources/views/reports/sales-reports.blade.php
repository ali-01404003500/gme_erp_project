                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <select name="invoice_id" class="tom-select" data-placeholder="Select Invoice ID">
                                            ...
                                            @foreach ($salesOrders as $order)
                                                <option value="{{ $order->sales_order_id }}" {{ request('invoice_id') == $order->sales_order_id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <select name="invoice_type" class="form-control">
                                            ...
                                            <option value="delivered" {{ request('invoice_type') == 'delivered' ? 'selected' : '' }}>Delivered
                                            </option>
                                            <option value="undelivered" {{ request('invoice_type') == 'undelivered' ? 'selected' : '' }}>
                                                Undelivered</option>
                                            <option value="pending" {{ request('invoice_type') == 'pending' ? 'selected' : '' }}>Pending
                                            </option>
                                            <option value="partial_sales" {{ request('invoice_type') == 'partial_sales' ? 'selected' : '' }}>Partial
                                                Sales</option>
                                            <option value="free_sales" {{ request('invoice_type') == 'free_sales' ? 'selected' : '' }}>Free Sales
                                            </option>
                                            <option value="sales_return" {{ request('invoice_type') == 'sales_return' ? 'selected' : '' }}>Sales
                                                Return</option>
                                            <option value="backup_challan" {{ request('invoice_type') == 'backup_challan' ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <select name="sales_type" class="form-control">
                                            ...
                                            <option value="general_sales" {{ request('sales_type') == 'general_sales' ? 'selected' : '' }}>Sales
                                            </option>
                                            <option value="partial_sales" {{ request('sales_type') == 'partial_sales' ? 'selected' : '' }}>Partial
                                                Sales</option>
                                            <option value="free_sales" {{ request('sales_type') == 'free_sales' ? 'selected' : '' }}>Free Sales
                                            </option>
                                        </select>
                                    </div>
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <table class="table sales-report-table table-hover table-sm" id="salesReportTable"
                                    ...
                                    <tbody>
                                        ...
                                        @forelse($reportData as $index => $item)
                                                                                ...
                                                                                <tr class="{{ $invoiceType == 'Sales Return' ? 'table-warning' : '' }}">
                                                                                    <td class="text-center">{{ $rowNumber }}
                                                                    </div>
                                                                    <td style="word-wrap: break-word; white-space: normal; min-width: 200px;">
                                                                        ...
                                                                        @endphp
                                                                        <a href="{{ $route }}" target="_blank" class="text-primary font-weight-bold">
                                                                            {{ $label }}
                                                                        </a>
                                                                    </td>
                                                                    <td>
                                                                    ...
                                                                    <td>{{ optional($data->createdBy)->branch->name ?? 'N/A' }}
                                                                    </td>
                                                                <td style="word-wrap: break-word; white-space: normal; min-width: 200px;">
                                                            ...
                                                            <td style="word-wrap: break-word; white-space: normal; min-width: 200px;">
                                                                {{ optional($data->customer)->address ?? 'N/A' }}
                                                            </td>
                                                        <td>{{ optional($data->customer)->phone ?? 'N/A' }}
                                                        </td>
                                                    <td class="text-right">
                                                        @php
                                                ...
                                                <td>
                                                    ...
                                                    @endphp
                                                    <span class="badge {{ $statusBadgeClass }} badge-round">{{ $invoiceStatus }}</span>
                                            </td>
                                            <td>{{ $data->remarks ?? '' }}</td>
                                            <td>{{ optional($data->createdBy)->name ?? 'N/A' }}</td>
                                            <td>{{ $data->reference_invoice ?? (optional($data->reference)->sales_order_id ?? '') }}
                                                @if($data->reference)({{$data->reference->invoice_date ?? ''}})
                                                @endif
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                @endphp
                                                <span class="badge {{ $typeBadgeClass }} badge-round">{{ $invoiceType }}</span>
                                            </td>
                                            <td class="text-right">{{ number_format($data->discount ?? 0) }}
                                            </td>
                                            ...
                                            <td class="text-center">
                                                @if (isset($data->attachments) && $data->attachments)
                                                    <a href="{{ asset($data->attachments) }}" target="_blank" class="badge badge-secondary badge-round">
