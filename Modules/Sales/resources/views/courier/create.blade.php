@section('title', 'Create Courier Information')
@section('description', 'Create Courier Information')
@extends('layout.app')
@section('content')
        ...
        <div class="social-dash-wrap">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">
                                        {{ trans('menu.create-courier-menu-title') }}</li>
                                </ol>
                            </nav>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12 m-2">
                    <h4 class="text-capitalize breadcrumb-title">{{ trans('menu.create-courier-menu-title') }}</h4>
                    <x-error-alart />
                </div>
                ...
                <div class="col-md-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            <form method="POST" action="{{ route('sales.couriers.store') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="courier_branch" id="courier_branch"
                                                placeholder="Enter Courier Branch" value="{{ old('courier_branch') }}" required>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="courier_phone" id="courier_phone"
                                                placeholder="Enter Courier Contact Number" value="{{ old('courier_phone') }}" required>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="courier_address" id="courier_address"
                                                placeholder="Enter Courier Address" value="{{ old('courier_address') }}" required>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="courier_email" id="courier_email"
                                                placeholder="Enter Courier Mail" value="{{ old('courier_email') }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="contact_person_designation" id="contact_person_designation"
                                                placeholder="Enter Contact Person Designation" value="{{ old('contact_person_designation') }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="contact_person_address" id="contact_person_address"
                                                placeholder="Enter Contact Person Address" value="{{ old('contact_person_address') }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="web_link" id="web_link"
                                                placeholder="Courier Tracking Address" value="{{ old('web_link') }}">
