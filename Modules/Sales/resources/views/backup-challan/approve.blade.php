        ...
        <div class="social-dash-wrap">
                ...
                <div class="col-lg-12">
                    <div class="breadcrumb-main">
                        ...
                        <div class="action-btn mt-sm-0 mt-15 d-flex">
                            ...
                            @endif
                            <a href="{{ route('sales.backup-challans.index') }}"
                                class="btn btn-warning btn-default btn-squared radius-md shadow2 btn-sm ms-2"><i
            ...
            <div class="row">
                <div class="col-md-12 m-2">
                    <h4 class="text-capitalize breadcrumb-title">{{ trans('menu.update-backup-challan-menu-title') }}</h4>
                    <x-error-alart />
                </div>
                <div class="col-md-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            <form action="{{ route('sales.backup-challans.approveStore', $backupChallan->id) }}"
                                    ...
                                    <div class="col-md-4  mt-4">
                                        <div class="form-group">
                                            ...
                                            <select name="type" id="type" class="form-control">
                                                <option value="Backup"
                                                    {{ old('type', $backupChallan->type) == 'Backup' ? 'selected' : '' }}>
                                                    Backup</option>
                                                <option value="Challan"
                                                    {{ old('type', $backupChallan->type) == 'Challan' ? 'selected' : '' }}>
                                                    Challan</option>
                                            </select>
                                        </div>
                                    </div>
                                            ...
                                            <select name="customer_id" id="customer_id" class="form-control tom-select">
                                                ...
                                                @foreach ($customers as $customer)
                                                    <option value="{{ $customer->id }}"
                                                        {{ old('customer_id', $backupChallan->customer_id) == $customer->id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-4  mt-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="invoice_no" class="form-control" id="invoice_no"
                                                ...
                                                value="{{ old('invoice_no', $backupChallan->invoice_no) }}">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="row mt-4">
                                                                            ...
                                                                            <select name="product_ids[]"
                                                                                ...
                                                                                @foreach ($products as $product)
                                                                                    <option value="{{ $product->id }}"
                                                                                        {{ $product->id == $backupChallanDetail->product_id ? 'selected' : '' }}>
                                                                                        {{ $product->name }}</option>
                                                                                @endforeach
                                                    ...
                                                    <fieldset class="border p-2">
                                                        <legend class="float-none w-auto p-2">
                                                            ...
                                                            <input type="checkbox" name="is_shipment" value="1"
                                                                @if ($backupChallan->is_shipment == 1) checked @endif
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="mb-3">
                                                                    <select name="courier_id" id="courier_id"
                                                                        ...
                                                                        <option value="" selected>Select Courier
                                                                        </option>
                                                                        @foreach ($couriers as $courier)
                                                                            <option value="{{ $courier->id }}"
                                                                                {{ $courier->id == optional($backupChallan->backupChallanShipments->first())->courier_id ? 'selected' : '' }}>
                                                                ...
                                                                <select name="area_id" id="area_id"
                                                                    ...
                                                                    @foreach ($areas as $area)
                                                                        <option value="{{ $area->id }}"
                                                                            {{ optional($backupChallan->backupChallanShipments->first())->area_id == $area->id ? 'selected' : '' }}>
                                                                            {{ $area->area }}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="mb-3">
                                                                    <input type="text" name="address"
                                                                        ...
                                                                        value="{{ old('address', optional($backupChallan->backupChallanShipments->first())->address ?? '') }}"
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="mb-3">
                                                                    <input type="text" name="contact_person_name"
                                                                        value="{{ old('contact_person_name', optional($backupChallan->backupChallanShipments->first())->contact_person_name ?? '') }}"
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="mb-3">
                                                                    <input type="text" name="contact_person_number"
                                                                        value="{{ old('contact_person_number', optional($backupChallan->backupChallanShipments->first())->contact_person_number ?? '') }}"
