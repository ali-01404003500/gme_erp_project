                ...
                <div class="col-lg-12">
                    <div class="breadcrumb-main">
                        ...
                        <div class="action-btn mt-sm-0 mt-15 row">
                            ...
                            <a href="{{ route('sales.quotations.create') }}" class="btn px-20 btn-primary btn-sm" style="margin-left: 5px;">
                                                                        ...
                                                                        <select name="product_ids[]"
                                                                            class="form-control product_ids to-select">
                                                                             <option value="{{ $quotationDetail->product_id }}" selected>
                                                                                    {{ $quotationDetail->product->name }}</option>
                                            ...
                                            <fieldset class="border p-2">
                                                <legend class="float-none w-auto p-2">
                                                    ...
                                                    <input type="checkbox" name="termsConfirm" id="termsConfirm"
                                                        tabindex="1015" checked>
                                                </legend>
                                                <div class="row termsConditions" id="termsConditions">
