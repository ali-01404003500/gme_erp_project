@extends('layout.app')
@section('title', 'Sales Return Verification') 
@section('description', 'Sales Return Verification') 
@section('content')
        ...
        <div class="social-dash-wrap">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">
                                        {{ trans('Sales Return Verification ') }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-12 m-2">
                    <h4 class="text-capitalize breadcrumb-title">{{ trans('Sales Return Verification') }}</h4>
                    <x-error-alart />
                ...
                <div class="col-md-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            <form action="{{ route('sales.sales-returns.approve.store', $salesReturn->id) }}" method="POST"
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-6  mt-4">
                                        <div class="form-group">
                                            ...
                                            {{ optional($salesReturn)->invoice_no }}
                                            <input type="hidden" name="sales_return_id"
                                    ...
                                    <div class="col-md-6 mt-4">
                                        <div class="input-group ">
                                            ...
                                            {{ $salesReturn->reference_invoice }}
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="invoice_date">Return Date : </label>
                                            {{ date('d F, Y', strtotime($salesReturn->return_date)) }}
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="supplier_id">Customer Name :</label>
                                            {{ optional(optional($salesReturn)->customer)->company_name }}
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="customer_address">Customer Address : </label>
                                            {{ optional(optional($salesReturn)->customer)->address }}
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="time">Time : </label>
                                            {{ date('h:i A', strtotime($salesReturn->created_at)) }}
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="created_by">Return By : </label>
                                                ...
                                                <table class="table table-bordered" id="product_info_table">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            {{-- <th class="text-center" style="width: 10%;">Sales Price</th> --}}
                                                            <th class="text-center" style="width: 10%;">Return Price</th>
                                                            <th class="text-center" style="width: 10%;">Return Quantity</th>
                                                            <th class="text-center" style="width: 15%">Quantity</th>
                                                            <th class="text-center" style="width: 15%">Action</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody id="productTable">
                                                        @foreach ($salesReturn->salesReturnDetails as $key => $item)
                                                            <tr id="product_{{ $item->product_id }}">
                                                                ...
                                                                {{-- <td class="text-center">
                                                                    {{ numberFormat($item->salesOrderDetail->price ?? 0) }}
                                                                </td> --}}
                                                                <td class="text-center">
                                                                ...
                                                                <td class="text-center">
                                                                    ...
                                                                    <div class="btn-group btn-group-sm">
                                                                        <button type="button"
                                                                            ...
                                                                            data-url="{{ route('sales.sales-returns.select-stock', ['product_id' => $item->product_id, 'sales_order_id' => $salesReturn->sales_order_id, 'sales_return_id' => $salesReturn->id]) }}">
