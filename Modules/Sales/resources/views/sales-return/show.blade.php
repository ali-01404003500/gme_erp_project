                ...
                <div class="col-lg-12">
                    <div class="breadcrumb-main">
                        ...
                        <div class="row">
                            ...
                            {{-- <a href="{{ route('sales.sales-returns.show', $salesReturn->id) }}?export=pdf" target="_blank"
                            ...
                            <div id="print-content">
                                    ...
                                    <div class="left">
                                        <table>
                                            <tr>
                                                <th>Invoice No</th>
                                                <td>:</td>
                                                <th>{{ $salesReturn->invoice_no }}</th>
                                            </tr>
                                            <tr>
                                                <th>Customer name</th>
                                                <td>:</td>
                                                <th>{{ $salesReturn->customer->company_name }}</th>
                                            </tr>
                                            <tr>
                                                <th>Address</th>
                                                <td>:</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>:</td>
                                                <th> {{ $salesReturn->reference_invoice }}</th>
                                            </tr>
                                        </table>
                                    </div>
                                    <div class="right">
                                        <table>
                                            ...
                                            <tr>
                                                <th>Date</th>
                                                <td>:</td>
                                                <th>{{ $salesReturn->return_date }}</th>
                                            </tr>
                                            <tr>
                                                <th>Time</th>
                                                <td>:</td>
                                                <th>{{ date('h:i A', strtotime($salesReturn->created_at)) }}</th>
                                            </tr>
                                            <tr>
                                                <th>Returnd By</th>
                                                <td>:</td>
                                                <th>{{ $salesReturn->createdBy->name }}</th>
                                            </tr>
                                            <tr>
                                                <th>Print Date</th>
                                                <td>:</td>
                                ...
                                <section class="invoice-details">
                                    <table>
                                        ...
                                        <tbody>
                                            @foreach ($salesReturn->salesReturnDetails as $salesReturnDetail)
                                                <tr>
                                                    <td style="width: 15px;">{{ $loop->iteration }}</td>
                                                    <td>{{ $salesReturnDetail->product->name }}</td>
                                                    <td>{{ numberFormat($salesReturnDetail->quantity) }}</td>
                                                    <td>{{ numberFormat($salesReturnDetail->price) }}</td>
                                                    <td id="discount1">{{ numberFormat($salesReturnDetail->total_discount) }}</td>
                                                    <td>{{ numberFormat($salesReturnDetail->amount) }} </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                                    <section class="requisition-info"
                                        ...
                                        <div class="left" style="width: 70%;">
                                            <table>
                                                <p>IN WORD : {{ convert_number($salesReturn->total_amount) }} Taka Only</p>
                                            </table>
                                        </div>
                                            ...
                                            <table style="border: none!important;">
                                                <tr style="border: none!important;">
                                                    ...
                                                    <td style="border: none!important; text-align: end;">
                                                        <strong>{{ $salesReturn->total_amount }}</strong>
                                                    </td>
                                                </tr>
                                                <tr style="border: none!important;">
                                                    ...
                                                    <td style="border: none!important;">:</td>
                                                    <td style="border: none!important; text-align: end;">
                                                        <strong>{{ $salesReturn->discount }}</strong>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr id="vat-and-net-amount" style="border: none!important;">
                                                    ...
                                                    <td style="border: none!important; text-align: end;" id="net-amount">
                                                        <strong>{{ $salesReturn->net_amount }}</strong>
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
                                    ...
                                    <section>
                                        <div id="remarks">
                                            ...
                                            <p style="text-align: justify;">{{ $salesReturn->remarks }}</p>
                                        </div>
                                    </section>
