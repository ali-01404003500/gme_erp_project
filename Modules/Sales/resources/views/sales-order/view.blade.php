    ...
    <div class="col-md-12">
        <div class="card mb-4">
            <div class="card-body">
                ...
                <section class="sales-order-info" style="font-size: 10px;">
                    <div class="left">
                        <table style="border: 1px solid white;">
                            <tr style="border: 1px solid white;">
                                ...
                                <th style="border: 1px solid white; font-size: 10px;">{{ $salesOrder->customer->company_name }}</th>

                                <th style="border: 1px solid white; font-size: 10px;">Invoice Date</th>
                                <td style="border: 1px solid white; font-size: 10px;">:</td>
                                <th style="border: 1px solid white; font-size: 10px;">{{ $salesOrder->invoice_date }}</th>
                            </tr>
                            <tr style="border: 1px solid white;">
                                <th style="border: 1px solid white; ; font-size: 10px;">Address</th>
                                <td style="border: 1px solid white; ; font-size: 10px;">:</td>
                                <th style="border: 1px solid white; ; font-size: 10px;">{{$salesOrder->customer->address}}</th>
                            
                                <th style="border: 1px solid white; ; font-size: 10px;">Sold By</th>
                                <td style="border: 1px solid white; ; font-size: 10px;">:</td>
                                <th style="border: 1px solid white; ; font-size: 10px;">{{ optional($salesOrder->requisitionBy)->name }}</th>
                            </tr>
                            <tr style="border: 1px solid white;">
                                <th style="border: 1px solid white; font-size: 10px;">Phone No</th>
                                <td style="border: 1px solid white; font-size: 10px;">:</td>
                                <th style="border: 1px solid white; font-size: 10px;"> {{ $salesOrder->additional_phone }}</th>

                                <th style="border: 1px solid white; ; font-size: 10px;">Print Date</th>
                                <td style="border: 1px solid white; ; font-size: 10px;">:</td>
                                <th style="border: 1px solid white; ; font-size: 10px;">{{ now()->format('d-M-Y') }}</th>
                            </tr>
                        </table>
                    </div>
                </section>
                ...
                <section class="invoice-details">
                    <table>
                        <tr>
                            ...
                            <th  style="font-size: 11px;">Unit Discount</th>
                            <th  style="font-size: 11px;">Total Discount</th>
                        ...
                        <tbody>
                            @foreach ($salesOrder->salesOrderDetails as $salesOrderDetail)
                                ...
                                <tr>
                                    ...
                                    <td  style="font-size: 10px;">
                                        {{ numberFormat($salesOrderDetail->quantity) }}
                                    </td>
                                    <td  style="font-size: 10px;">{{ numberFormat($salesOrderDetail->price) }}
                                    </td>
                                    <td  style="font-size: 10px;">{{ numberFormat($salesOrderDetail->unit_discount) }}</td>
                                    <td  style="font-size: 10px;">{{ numberFormat($salesOrderDetail->total_discount) }}</td>
                                    <td  style="font-size: 10px;">{{ numberFormat($salesOrderDetail->amount) }} </td>
                        ...
                        <table style="margin-top:0!important;">
                            <tr>
                                <td width="60%" rowspan="5" style="margin-top:0!important; border: 1px solid white!important;">
                                    <p style="font-size: 10px;">IN WORD : One Thousend Taka Only</p>
                                </td>
                                ...
                                <td style="border: 1px solid white!important; text-align: right; margin-top:0!important; font-size: 10px;">
                                    <strong>{{ number_format($salesOrder->total_amount, 2, '.', '') }}</strong>
                                </td>
                            </tr>
                            ...
                            <tr style="border: 1px solid white!important; margin-top:0!important;">
                                ...
                                <td style="border: 1px solid white!important; text-align: right; margin-top:0!important; font-size: 10px;">
                                    <strong>{{ number_format($salesOrder->commission, 2, '.', '') }}</strong>
                                </td>
                            </tr>
                            <tr style="border: 1px solid white!important; margin-top:0!important;">
                                <td style="border: 1px solid white!important; text-align: left; margin-top:0!important; font-size: 10px;">
                            ...
                            <tr style="border: 1px solid white!important; margin-top:0!important;">
                                ...
                                <td style="border: 1px solid white!important; text-align: right; margin-top:0!important; font-size: 10px;">
                                    <strong>{{ number_format($salesOrder->vat, 2, '.', '') }}</strong>
                                </td>
                            </tr>
                        </table>
                    </section>
                ...
                <section class="payment-info" style="width: 60%; display: flex; justify-content: flex-start;">
                    <table style="border: 1px solid black!important; padding: 5px;">
                        ...
                        <tr style="border: 1px solid black!important; width: 100%; padding: 5px;">
                            <th
                                style="width: 50%; border: 1px solid black!important; border-right: 1px solid rgb(255, 255, 255)!important; padding: 5px;">
                                Last Collection Date</th>
                            <td
                                style="width: 50%; border-left: 1px solid rgb(255, 255, 255)!important; border-right: 1px solid rgb(255, 255, 255)!important; padding: 5px;">
                                :</td>
                            <td style="width: 50%; border: 1px solid black!important; text-align: end; padding: 5px;">
                                <strong>23-Jun-2024(3,500.00)</strong>
                            </td>
                        </tr>
                        <tr style="border: 1px solid black!important; width: 100%; padding: 5px;">
                            <th
                ...
                <div style='margin-top: 50px;  font-family: "Noto Sans Bengali", sans-serif!important;'>
                    <section>
