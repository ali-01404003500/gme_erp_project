@section('title', 'Sales Order Delivery Details')
@section('description', 'Sales Order Delivery Details')
@extends('layout.app')
@section('content')
        ...
        <div class="social-dash-wrap">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">
                                        {{ trans('Sales Order Delivery Details') }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-12 m-2">
                    <h4 class="text-capitalize breadcrumb-title">{{ trans('Sales Order Delivery Details') }}</h4>
                </div>
                <div class="col-md-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <section class="title">
                                <h2>Sales Order Delivery Details</h2>
                            </section>
                                ...
                                <div class="left">
                                    <table>
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <th>{{ $salesOrderDelivery->sales_order_id }}</th>
                                        </tr>
                                        <tr>
                                            <th>Customer Name</th>
                                            <td>:</td>
                                            <th>{{ $salesOrderDelivery->salesOrder->customer->company_name }}</th>
                                        </tr>
                                    </table>
                                </div>
                                <div class="right">
                                    <table>
                                        <tr>
                                            <th>Invoice Date</th>
                                            <td>:</td>
                                            <td>{{ $salesOrderDelivery->created_at->format('d F, Y') }}</td>
                                        </tr>
                                    </table>
                                </div>
                            </section>
                            ...
                            <section class="invoice-details">
                                <table>
                                    ...
                                    <tbody>
                                        <tr>
                                            @foreach ($salesOrderDelivery->salesOrderDeliveryDetails as $key => $item)
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            <td>
                                                {{ $item->product->name }}
                                            ...
                                            <td>
                                                {{ $item->salesProductOrderDetail()->quantity}}
                                            </td>
                                            <td>
                                                {{ $item->quantity }}
                                            </td>
