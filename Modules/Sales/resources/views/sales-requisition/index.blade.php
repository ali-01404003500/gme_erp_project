            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <style>
                                    .sales-requisition-table-custom,
                                    .sales-requisition-table-custom th,
                                    .sales-requisition-table-custom td {
                                    ...
                                    .sales-requisition-table-custom thead th {
                            ...
                            <table id="zero-config"class="table sales-requisition-table-custom dt-table-hover" data-page='@include('utils.table_paginate', ['data' => $salesRequisitions])'
                                style="width:100%">
                                <thead>
                                    <tr>
                                        <th>SL</th>
