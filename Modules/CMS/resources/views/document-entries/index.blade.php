    ...
    <div class="social-dash-wrap">
                ...
                <div class="breadcrumb-main">
                    ...
                    <div class="breadcrumb-main__wrapper">
                        <div class="action-btn mt-sm-0 mt-15 d-flex align-items-center">
                            ...
                            @endif
                            <a href="{{ route('cms.document-entries.index') }}?export_type=pdf&{{ http_build_query(request()->except('export_type', '_token')) }}" target="_blank"
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <table id="zero-config"class="table dt-table-hover" data-page='@include('utils.table_paginate', ['data' => $documentEntries])' style="width:100%">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                @foreach ($documentEntries as $value )
                                    <tr>
                                        <td class="text-center">{{ ($documentEntries->currentPage() - 1) * $documentEntries->perPage() + $loop->iteration  }}</td>
                                            ...
                                            <div class="btn-group btn-group-sm" role="group" aria-label="Small button group">
                                                ...
                                                <a class="btn btn-outline-info" href="{{ $value->attachment }}" download>
                                                    ...
                                                    @if(hasPermission('cms.document-entries.update'))
                                                        <a class="btn btn-outline-warning" href="{{ route('cms.document-entries.edit', $value->id) }}"><i
