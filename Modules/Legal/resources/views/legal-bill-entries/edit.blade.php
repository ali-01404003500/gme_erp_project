@extends('layout.app')
@section('title', 'Edit Legal Bill Entry')
@section('description', 'Edit Legal Bill Entry')
@section('content')
        ...
        <div class="social-dash-wrap">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">
                                        {{ trans('Edit Legal Bill Entry') }}</li>
                                </ol>
                            </nav>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12 m-2">
                    <h4 class="text-capitalize breadcrumb-title">{{ trans('Edit Legal Bill Entry') }}</h4>
                    <x-error-alart />
                </div>
                    ...
                    <div class="row justify-content-center" id="justify-content-center">
                        <div class="col-sm-11">
                            <div class="mt-40 mb-50">
                                <h2 class="mb-3">Edit Legal Bill Entry</h2>
                                <form action="{{ route('legal.legal-bill-entries.update',  $legalBillEntry->id )}}"
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="date" id="date"
                                                    ...
                                                    value="{{ old('date', $legalBillEntry->date) }}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="vendor_id" id="advocate_name"
                                                    ...
                                                    @foreach ($advocates as $advocate)
                                                        <option value="{{ $advocate->id }}"
                                                            {{ $legalBillEntry->vendor_id == $advocate->id ? 'selected' : '' }}>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="legal_entry_id" id="case_name"
                                                    class="form-control tom-select px-15">
                                                    <option value="">Select Case</option>
                                                    @foreach ($legalEntries as $case)
                                                        <option value="{{ $case->id }}"
                                                            data-case_no="{{ $case->case_no }}"
                                                            {{ $legalBillEntry->legal_entry_id == $case->id ? 'selected' : '' }}>
                                                            {{ $case->case_no }} (
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="particular" id="particular"
                                                    value="{{ old('particular', $legalBillEntry->particular) }}"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="amount" id="amount"
                                                    value="{{ old('amount', $legalBillEntry->amount) }}"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <x-file-uploader multiple :value="$legalBillEntry->attachment" name="attachment" />
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="description" id="description" class="form-control px-15" rows="3">{{ old('description', $legalBillEntry->description) }}</textarea>
                                            </div>
                                        </div>
                                    </div>
