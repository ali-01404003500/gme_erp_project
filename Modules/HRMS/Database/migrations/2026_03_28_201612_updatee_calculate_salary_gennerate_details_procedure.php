    ...
    public function up()
    {
        DB::unprepared("
            ...
            BEGIN  
                ...
                SET salary_payment = 
                    (basic_salary + house_rent_salary + medical_salary + conveyance_salary + entertainment_salary + leave_fare_salary + utility_salary + unkeep_salary + others_salary)
                    - (absent_deduction + late_deduction + leave_deduction + loan_deduction + advance_deduction + tax_deduction_amt);
