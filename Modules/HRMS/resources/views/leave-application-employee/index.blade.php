...
@section('content')
    <div class="container-fluid">
        <div class="social-dash-wrap">
                    ...
                    <div class="breadcrumb-main">
                        ...
                        <div class="breadcrumb-main__wrapper">
                            <div class="action-btn mt-sm-0 mt-15 d-flex align-items-center">
                                @if (hasPermission('hrm.leave-application-employees.create'))
                                    <a href="{{ route('hrm.leave-application-employees.create') }}" class="btn px-20 btn-primary btn-sm">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h4 class="text-capitalize breadcrumb-title">Leave Application</h4>
                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group btn-group-sm" role="group"
                                                    ...
                                                    @if (hasPermission('hrm.leave-application-employees.update') && $value->status == 'pending')
                                                        <a class="btn btn-outline-warning"
                                                            href="{{ route('hrm.leave-application-employees.edit', $value->id) }}"
                                                            title="Edit"><i class="far fa-edit"></i></a>
                                                    @endif 

                                                    @if (hasPermission('hrm.leave-application-employees.destroy') && $value->status == 'pending')
                                                        <button type="button"
                                                            data-action="{{ route('hrm.leave-application-employees.destroy', $value->id) }}"
                                                            class="btn btn-outline-danger delete-confirm"
                                                            title="Delete"><i class="far fa-trash-alt"></i></button>
                                                    @endif

                                                    <button type="button"
                                                        data-action="{{ route('hrm.leave-application-employees.show', $value->id) }}"
                                                        data-data="{{ $value->id }}"
