                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-25">
                                                ...
                                                <input type="text" name="effective_date" id="effective_date" class="form-control flatdate" value="{{ old('effective_date',  date('Y-m-d')) }}" required>
                                        ...
                                        <div class="form-group row mb-25 col-md-4">
                                            ...
                                            <div class="col-md-5">
                                                <div class="checkbox-theme-default custom-checkbox m-2">
                                                    <input class="checkbox" name="is_house_rent_basic" value="1" @if (old('is_house_rent_basic') == 1) checked  @endif
                                        ...
                                        <div class="form-group row mb-25 col-md-4">
                                            ...
                                            <div class="col-md-5">
                                                <div class="checkbox-theme-default custom-checkbox m-2">
                                                    <input class="checkbox" name="is_conveyance_basic" value="1" @if (old('is_conveyance_basic') == 1) checked  @endif
                                        ...
                                        <div class="form-group row mb-25 col-md-4">
                                            ...
                                            <div class="col-md-5">
                                                <div class="checkbox-theme-default custom-checkbox m-2">
                                                    <input class="checkbox" name="is_medical_basic" value="1" @if (old('is_medical_basic') == 1) checked  @endif
                                         ...
                                         <div class="form-group row mb-25 col-md-4">
                                            ...
                                            <div class="col-md-5">
                                                <div class="checkbox-theme-default custom-checkbox m-2">
                                                    <input class="checkbox" name="is_entertainment_basic" value="1" @if (old('is_entertainment_basic') == 1) checked  @endif
                                        ...
                                        <div class="form-group row mb-25 col-md-4">
                                            ...
                                            <div class="col-md-5">
                                                <div class="checkbox-theme-default custom-checkbox m-2">
                                                    <input class="checkbox" name="is_leave_fare_basic" value="1" @if (old('is_leave_fare_basic') == 1) checked  @endif
                                         ...
                                         <div class="form-group row mb-25 col-md-4">
                                            ...
                                            <div class="col-md-5">
                                                <div class="checkbox-theme-default custom-checkbox m-2">
                                                    <input class="checkbox" name="is_utility_basic" value="1" @if (old('is_utility_basic') == 1) checked  @endif
                                         ...
                                         <div class="form-group row mb-25 col-md-4">
                                            ...
                                            <div class="col-md-5">
                                                <div class="checkbox-theme-default custom-checkbox m-2">
                                                    <input class="checkbox" name="is_unkeep_basic" value="1" @if (old('is_unkeep_basic') == 1) checked  @endif
                                        ...
                                        <div class="form-group row mb-25 col-md-4">
                                            ...
                                            <div class="col-md-5">
                                                <div class="checkbox-theme-default custom-checkbox m-2">
                                                    <input class="checkbox" name="is_others_basic" value="1" @if (old('is_others_basic') == 1) checked  @endif
