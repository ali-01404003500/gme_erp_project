                                ...
                                <form action="{{ route('hrm.settings.salary-setups.store', app()->getLocale()) }}" method="POST"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group row mb-25">
                                            ...
                                            <div class="col-md-3">
                                                <div class="checkbox-theme-default custom-checkbox m-2">
                                                    <input class="checkbox" name="is_conveyance_fixed" value="1" @if (old('is_conveyance_fixed') == 1) checked  @endif
                                        ...
                                        <div class="form-group row mb-25">
                                            ...
                                            <div class="col-md-3">
                                                <div class="checkbox-theme-default custom-checkbox m-2">
                                                    <input class="checkbox" name="is_medical_fixed" value="1" @if (old('is_medical_fixed') == 1) checked  @endif
                                        ...
                                        <div class="form-group row mb-25">
                                            ...
                                            <div class="col-md-3">
                                                <div class="checkbox-theme-default custom-checkbox m-2">
                                                    <input class="checkbox" name="is_others_fixed" value="1" @if (old('is_others_fixed') == 1) checked  @endif
