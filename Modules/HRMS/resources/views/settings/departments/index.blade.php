                ...
                <div class="col-md-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <table id="zero-config" class="table table-bordered-custom dt-table-hover" data-page='@include('utils.table_paginate', ['data' => $departments])' style="width:100%" >
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($departments as $key => $item)
                                        <tr>
                                        <td class="text-left">{{ ($departments->currentPage() - 1) * $departments->perPage() + $loop->iteration  }}</td>
