        ...
        <div class="card border-0 shadow-sm mb-4">
            <div class="card-body p-0">
                <div class="table-responsive">
                    <style>
                        .leavegroup-table-custom,
                        .leavegroup-table-custom th,
                        .leavegroup-table-custom td {
                        ...
                        .leavegroup-table-custom thead th {
                            background-color: #f8f9fa;
                            border-bottom-width: 2px !important;
                        }
                    </style>

                    <table class="table leavegroup-table-custom table-hover align-middle mb-0">
                                ...
                                <tr class="">
                                    ...
                                    <td class="text-end pe-4">
                                        <div class="d-flex justify-content-end gap-2">
                                            ...
                                            <form action="{{ route('hrm.leave-groups.destroy', $group->id) }}" method="POST"
