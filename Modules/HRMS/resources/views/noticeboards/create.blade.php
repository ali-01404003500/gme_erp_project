                    ...
                    <div class="row justify-content-center" id="justify-content-center">
                        <div class="col-sm-12">
                            <div class="mt-40 mb-50 p-30">
                                <form action="{{ route('hrm.noticeboards.store', app()->getLocale()) }}" method="POST"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group mb-25">
                                                ...
                                                <input type="text" class="form-control" value="{{ old('title') }}" name="title" id="title" placeholder="Title" required>
                                                @if ($errors->has('title'))
                                            ...
                                            <div class="form-group mb-25">
                                                ...
                                                <select name="notice_type_id" id="type" class="form-control tom-select" required>
                                                    ...
                                                    @foreach ($noticeTypes as $noticeType)
                                                        <option value="{{ $noticeType->id }}" {{ (old('type') == $noticeType->id) ? 'selected' : '' }}>{{ $noticeType->name }}</option>
                                                    @endforeach
                                                </select>
                                                @if ($errors->has('type'))
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-25">
                                                ...
                                                <input type="text" class="form-control flatdate" value="{{ old('publish_date') }}" name="publish_date" id="publish_date" placeholder="Publish Date" required>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-25">
                                                ...
                                                <input type="text" class="form-control flattime" value="{{ old('publish_time') }}" name="publish_time" id="publish_time" placeholder="Publish Time" required>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-25">
                                                ...
                                                <input type="text" class="form-control flatdate" value="{{ old('expire_date') }}" name="expire_date" id="expire_date" placeholder="Expire Date" required>
