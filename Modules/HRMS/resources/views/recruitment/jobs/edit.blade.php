...
@section('description', 'Update Job ')
@extends('layout.app')
        ...
        <div class="social-dash-wrap">
            ...
            <div class="row">
                <div class="col-md-12 m-2">
                    <h4 class="text-capitalize breadcrumb-title">{{ trans('Job Update') }}</h4>
                    <x-error-alart />
                </div>
                ...
                <div class="col-md-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            <form method="POST" action="{{ route('hrm.jobs.update', $job) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            <select name="branch_id" class="form-control tom-select"
                                                ...
                                                @foreach ($branches as $id => $name)
                                                    <option value="{{ $id }}"
                                                        {{ old('branch_id', $job->branch_id) == $id ? 'selected' : '' }}>{{ $name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-sm-12">
                                            <select name="department_id" class="form-control tom-select">
                                                ...
                                                @foreach ($departments as $id => $name)
                                                    <option value="{{ $id }}"
                                                        {{ old('department_id', $job->department_id) == $id ? 'selected' : '' }}>
                                                        {{ $name }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-sm-12">
                                            <select name="designation_id" class="form-control tom-select">
                                                ...
                                                @foreach ($designations as $id => $name)
                                                    <option value="{{ $id }}"
                                                        {{ old('designation_id', $job->designation_id) == $id ? 'selected' : '' }}>
                                                        {{ $name }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-sm-12">
                                            <select name="job_type" class="form-control tom-select">
                                                ...
                                                <option value="Temporary"
                                                    {{ old('job_type', $job->job_type) == 'Temporary' ? 'selected' : '' }}>Temporary
                                                </option>
                                                <option value="Remote" {{ old('job_type', $job->job_type) == 'Remote' ? 'selected' : '' }}>
                                                    Remote</option>
                                                <option value="Contractual"
                                                    {{ old('job_type', $job->job_type) == 'Contractual' ? 'selected' : '' }}>Contractual
                                                </option>
                                                <option value="Others" {{ old('job_type', $job->job_type) == 'Others' ? 'selected' : '' }}>
                                                    Others</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" name="office_hours" value="{{ old('office_hours', $job->office_hours) }}"
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" name="weekend" value="{{ old('weekend', $job->weekend) }}"
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" name="start_at" value="{{ old('start_at', $job->start_at) }}"
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" name="deadline_at" value="{{ old('deadline_at', $job->deadline_at) }}"
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" name="salary" value="{{ old('salary', $job->salary == 'null' ? '' : $job->salary) }}"
                                                class="form-control only-number" placeholder="Salary Range">
                                            <input type="checkbox" name="negotiable" id="negotiable" value="1" @if($job->salary == Null) checked @endif>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="col-sm-12">
                                            <textarea class="summernotes form-control" name="description">{{ old('description', $job->description) }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="col-sm-12">
                                            <textarea class="summernotes form-control" name="company_overview">{{ old('company_overview', $job->company_overview) }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="col-sm-12">
                                            <textarea class="summernotes form-control" name="experience">{{ old('experience', $job->experience) }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="col-sm-12">
                                            <textarea class="summernotes form-control" name="employee_centric_policy">{{ old('employee_centric_policy', $job->employee_centric_policy) }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 mb-2">
                                        <div class="form-group formElement-editor">
                                            ...
                                            <textarea class="form-control trumbowyg" id="educational_requirement" name="educational_requirement" rows="2">{{ old('educational_requirement', $job->educational_requirement) }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 mb-2">
                                        <div class="form-group formElement-editor">
                                            ...
                                            <textarea class="form-control trumbowyg" id="responsibility" name="responsibility" rows="2">{{ old('responsibility', $job->responsibility) }}</textarea>
                                        </div>
                                    </div>
