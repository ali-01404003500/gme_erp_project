                                ...
                                <div class="row">
                                    ...
                                    <div class="dm-tab tab-horizontal">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane fade show active" id="tab-v-3" role="tabpanel"
                                                        ...
                                                        <div class="col-md-4 mb-4">
                                                            <div class="form-group">
                                                                <label for="email_accounts"
                                                                    ...
                                                                    Accounts:</label>
                                                                <textarea class="form-control ip-gray radius-xs b-light px-15" id="email_accounts" name="email_accounts"
                                                                    rows="3">{{ old('email_accounts') }}</textarea>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4 mb-4">
                                                            <div class="form-group">
