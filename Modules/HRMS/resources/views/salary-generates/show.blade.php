                ...
                <div class="col-lg-12">
                    <div class="breadcrumb-main">
                        ...
                        <div class="action-btn mt-sm-0 mt-15">
                            @if (hasPermission('hrm.salary-generate.index'))
                                <a href="{{ route('hrm.salary-generate.index') }}"
                    ...
                    <div class="row justify-content-center" id="justify-content-center">
                        <div class="col-sm-12">
                            <div class="mt-40 mb-50 p-30">
                                <div class="row">
                                    <h2 class="mb-30">Salary of {{ date('F Y', strtotime($salaryGenerate->year_month)) }}</h2>
                                    <div class="col-md-4">
                                        <div class="form-group mb-25">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="employee_name" id="employee_name"
                                                    class="form-control" value="{{ $salaryGenerate->employee->full_name }}"
                                                    readonly>
                                                <input type="hidden" name="employee_id" id="employee_id"
                                                    class="form-control" value="{{ $salaryGenerate->employee_id }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group mb-25">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="employee_address" id="employee_address"
                                                    class="form-control"
                                                    value="{{ $salaryGenerate->employee->present_address }}" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group mb-25">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="employee_mobile" id="employee_mobile"
                                                    class="form-control"
                                                    value="{{ $salaryGenerate->employee->personal_mobile }}" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 mt-25">
                                        <div class="form-group mb-25">
                                            <div class="input-group">
                                                ...
                                                <input type="text" value="{{ $salaryGenerate->status }}" class="form-control" readonly>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group mb-25">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="pay_date" id="pay_date"
                                                    class="form-control "
                                                    value="{{ optional($salaryGenerate)->pay_date }}" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <tr>
                                                    <td class="text-center">
                                                        <input type="number" name="basic" id="basic"
                                                            value="{{ old('basic', numberFormat($salaryGenerate->basic)) }}"
                                                            class="form-control" readonly>
                                                    </td>
                                                    <td class="text-center">
                                                        <input type="number" name="house_rent" id="house_rent"
                                                            value="{{ old('house_rent', numberFormat($salaryGenerate->house_rent)) }}"
                                                            class="form-control" readonly>
                                                    </td>
                                                    <td class="text-center">
                                                        <input type="number" name="conveyance" id="conveyance"
                                                            value="{{ old('conveyance', numberFormat($salaryGenerate->conveyance)) }}"
                                                            class="form-control" readonly>
                                                    </td>
                                                    <td class="text-center">
                                                        <input type="number" name="medical" id="medical"
                                                            value="{{ old('medical', numberFormat($salaryGenerate->medical)) }}"
                                                            class="form-control" readonly>
                                                    </td>
                                                    <td class="text-center">
                                                        <input type="number" name="others" id="others"
                                                            value="{{ old('others', numberFormat($salaryGenerate->others)) }}"
                                                            class="form-control" readonly>
                                                    </td>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="text-center">
                                                        <input type="number" name="ot_pay" id="ot_pay"
                                                            value="{{ old('ot_pay', numberFormat($salaryGenerate->ot_pay)) }}"
                                                            class="form-control" readonly>
                                                    </td>
                                                    <td class="text-center">
                                                        <input type="number" name="double_time_pay" id="double_time_pay"
                                                            value="{{ old('double_time_pay', numberFormat($salaryGenerate->double_time_pay)) }}"
                                                            class="form-control" readonly>
                                                    </td>
                                                    <td class="text-center">
                                                        <input type="text" name="commission" id="commission"
                                                            value="{{ old('commission', numberFormat($salaryGenerate->commission)) }}"
                                                            class="form-control" readonly>
                                                    </td>
                                                    <td class="text-center">
                                                        <input type="text" name="bonus" id="bonus"
                                                            value="{{ old('bonus', numberFormat($salaryGenerate->bonus)) }}"
                                                            class="form-control" readonly>
                                                    </td>
                                                    <td class="text-center">
                                                        <input type="text" name="leave_encashment"
                                                            id="leave_encashment"
                                                            value="{{ old('leave_encashment', numberFormat($salaryGenerate->leave_encashment)) }}"
                                                            class="form-control" readonly>
                                                    </td>
                                                </tr>
                                            </tbody>
                                                ...
                                                <tr>
                                                    <td class="text-center">
                                                        <input type="text" name="advance" id="advance"
                                                            value="{{ old('advance', numberFormat($salaryGenerate->advance)) }}"
                                                            class="form-control" readonly>
                                                    </td>
                                                    <td class="text-center">
                                                        <input type="text" name="loan" id="loan"
                                                            value="{{ old('loan', numberFormat($salaryGenerate->loan)) }}"
                                                            class="form-control" readonly>
                                                    </td>
                                                    <td class="text-center">
                                                        <input type="text" name="no_pay_leave" id="no_pay_leave"
                                                            value="{{ old('no_pay_leave', numberFormat($salaryGenerate->no_pay_leave)) }}"
                                                            class="form-control" readonly>
                                                    </td>
                                                    <td class="text-center">
                                                        <input type="text" name="absence" id="absence"
                                                            value="{{ old('absence', numberFormat($salaryGenerate->absence)) }}"
                                                            class="form-control" readonly>
                                                    </td>
                                                </tr>
                                            </tbody>
                                                ...
                                                <tr>
                                                    <td class="text-center">
                                                        <input type="text" name="tax" id="tax"
                                                            value="{{ old('tax', numberFormat($salaryGenerate->tax)) }}"
                                                            class="form-control" readonly>
                                                    </td>
                                                </tr>
                                            </tbody>
                                                ...
                                                <tr>
                                                    <td class="text-center">
                                                        <input type="text" name="gross" id="gross"
                                                            value="{{ old('gross', numberFormat($salaryGenerate->gross)) }}"
                                                            class="form-control" readonly>
                                                    </td>
                                                    <td class="text-center">
                                                        <input type="text" name="total_other_earnings"
                                                            id="total_other_earnings"
                                                            value="{{ old('total_other_earnings', numberFormat($salaryGenerate->total_other_earnings)) }}"
                                                            class="form-control" readonly>
                                                    </td>
                                                    <td class="text-center">
                                                        <input type="text" name="total_earnings" id="total_earnings"
                                                            value="{{ old('total_earnings', numberFormat($salaryGenerate->total_earnings)) }}"
                                                            class="form-control" readonly>
                                                    </td>
                                                    <td class="text-center">
                                                        <input type="text" name="total_deductions"
                                                            id="total_deductions"
                                                            value="{{ old('total_deductions', numberFormat($salaryGenerate->total_deductions)) }}"
                                                            class="form-control" readonly>
                                                    </td>
                                                    <td class="text-center">
                                                        <input type="text" name="total_tax" id="total_tax"
                                                            value="{{ old('total_tax', numberFormat($salaryGenerate->total_tax)) }}"
                                                            class="form-control" readonly>
                                                    </td>
                                                    <td class="text-center">
                                                        <input type="text" name="net_earning" id="net_earning"
                                                            value="{{ old('net_earning', numberFormat($salaryGenerate->net_earning)) }}"
                                                            class="form-control" readonly>
                                                    </td>
                                                </tr>
                                            </tbody>
...
{{-- @section('page_scripts')
    <script>
        $(document).ready(function() {
            ...
            $('#ot_pay, #double_time_pay, #commission, #bonus, #leave_encashment').on('keyup change',
                calculateOtherEarnings);
