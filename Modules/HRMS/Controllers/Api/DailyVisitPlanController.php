...
class DailyVisitPlanController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return response()->json([
            'data' => $result,
            'status' => true,
            'message' => 'Daily Visit Plan created successfully',
        ]);
    }
    ...
    public function show($id)
    {
        ...
        return response()->json([
            'data' => $data,
            'status' => true,
            'message' => 'Daily Visit Plan retrieved successfully',
        ]);
    }
    ...
    public function update(Request $request, DailyVisitPlan $dailyVisitPlan)
    {
        ...
        $result = $this->service->update($dailyVisitPlan, $validate);

        return response()->json([
            'data' => $result,
            'status' => true,
            'message' => 'Daily Visit Plan Updated successfully',
        ]);
    }
    ...
    public function destroy(DailyVisitPlan $dailyVisitPlan)
    {
        ...
        return response()->json([
            'data' => [],
            'status' => true,
            'message' => 'Daily Visit Plan deleted successfully',
        ]);
    }
}
