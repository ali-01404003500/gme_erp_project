<div class="sidebar__menu-group">
    <ul class="sidebar_nav">
        ...
        @if (hasPermission('access_control.*') || hasPermission('sms.*') || hasPermission('notifications.*') || hasPermission('history.*') || hasPermission('verification.*'))
            <li
                class="has-child {{ request()->routeIs('access_control.*') || request()->routeIs('sms.*') || request()->routeIs('notifications.*') || request()->routeIs('history.*') || request()->routeIs('verification.*')  ? 'open' : '' }}">
                <a href="#"
                    class="{{ request()->routeIs('access_control.*') || request()->routeIs('sms.*') || request()->routeIs('notifications.*') || request()->routeIs('history.*') || request()->routeIs('verification.*') ? 'active' : '' }}">
                ...
                <ul>
                    ...
                    @if (hasPermission('verification.verification-requests'))
                        <li>
                            <a href="{{ route('verification.verification-requests') }}"
                                class="{{ request()->routeIs('verification.verification-requests') ? 'active' : '' }}">
                                <span class="nav-icon uil uil-file-alt"></span>{{ t_('menu.verification-requests') }}
                            </a>
                        </li>
                    @endif
