        ...
        <div class="social-dash-wrap">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">
                                        {{ trans('menu.update-sms-template-menu-title') }}</li>
                                </ol>
                            </nav>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12 m-2">
                    <h4 class="text-capitalize breadcrumb-title">{{ trans('menu.update-sms-template-menu-title') }}</h4>
                    <x-error-alart />
                </div>
                ...
                <div class="col-md-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            <form method="POST" action="{{ route('sms.templates.update', $smsTemplate->id) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="col-md-10 mt-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="code_name" id="code_name"
                                                    placeholder="Template Code" value="{{ old('code_name', $smsTemplate->code_name) }}" required readonly>
                                        ...
                                        <div class="col-md-10 mt-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="template_title" id="template_title"
                                                    placeholder="Enter SMS template title" value="{{ old('template_title', $smsTemplate->template_title) }}" required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="service_name_id" id="service_name_id" class="form-control tom-select"
                                                    ...
                                                    @foreach ($serviceNames as $key => $value)
                                                        <option {{ request('service_name_id', $smsTemplate->service_name_id) == $value->id ? 'selected' : '' }}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="trigger_name_id" id="trigger_name_id" class="form-control tom-select"
                                                    ...
                                                    @foreach ($triggerNames as $key => $value)
                                                        <option {{ request('trigger_name_id', $smsTemplate->trigger_name_id) == $value->id ? 'selected' : '' }}
                                                            value="{{ $value->id }}" data-table_name="{{ $value->code }}">
                                                            {{ $value->name }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-10">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="template_body" id="template_body" class="form-control" cols="30" rows="10" required>{{ old('template_body', $smsTemplate->template_body) }}</textarea>
        ...
        $('#service_name_id').on('change', function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    const trigger = $('#trigger_name_id').val();
                    console.log(trigger);
                    ...
                    $('#trigger_name_id').prop('tomselect').setValue(trigger);

                }
            });
        });

        $('#service_name_id').trigger('change');

    });
</script>  
<script>
    $(document).ready(function() {
        var tableName = $('#service_name_id').find('option:selected').data('table_name');
