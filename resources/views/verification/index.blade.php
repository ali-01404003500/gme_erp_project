...
<div class="verification-center">
            ...
            <div class="verification-header-left">
                ...
                <div>
                    ...
                    <p class="verification-page-subtitle">
                        Manage and process all pending verification requests from one place.
                    </p>
            ...
            @foreach($verificationTabs as $tab)
                @if(hasPermission($tab['permission']))
                    <a href="javascript:void(0)"   class="verification-tab" data-key="{{ $tab['key'] }}"  data-url="{{ $tab['route'] }}"   >
                        <span class="verification-count zero" id="count-{{ $tab['key'] }}" > 0 </span>
    ...
    <div class="verification-frame-wrapper">
        ...
        <div
            class="verification-frame-loader"
            id="verificationFrameLoader"
        >
...
$(document).ready(function () {
    ...
    */
    ...
    const countsUrl = @json(route('verification.counts'));
    ...
    function updateVerificationCounts() {
        ...
        $.ajax({
            ...
            error: function (xhr) {
                ...
                console.error(
                    'Unable to load verification counts.',
                    xhr
                );
