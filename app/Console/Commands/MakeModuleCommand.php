...
class MakeModuleCommand extends Command
{
    ...
    public function handle()
    {
        ...
        $files = [
            ...
            'routes/api.php' => str_replace('${name}', Str::snake($name), File::get(__DIR__.'/stubs/routes-api.stub')),
            'routes/web.php' => str_replace('${name}', Str::snake($name), File::get(__DIR__.'/stubs/routes-web.stub')),
            'resources/views/partials/_sidebar.blade.php' => str_replace('${name}', Str::snake($name), File::get(__DIR__.'/stubs/_sidebar.stub')),
        ];
